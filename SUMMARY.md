...
* [Part III. Server Administration](server-administration/README.md)
  ...
  * [第 18 章 伺服器設定與操作](server-administration/runtime/README.md)
    ...
    * [18.4. 管理核心資源 #](server-administration/runtime/kernel-resources.md)
  ...
  * [第 30 章 即時編譯（JIT）](server-administration/jit/README.md)
    ...
    * [30.2. 何時該使用 JIT？ #](server-administration/jit/jit-decision.md)
...
* [第五部分：伺服器程式設計](server-programming/README.md)
  * [第 36 章 擴充 SQL](server-programming/extend/README.md)
    ...
    * [36.10. C 語言函式 #](server-programming/extend/xfunc-c.md)
