...
see [Section 18.9.2](../runtime/ssl-tcp.md#SSL-OPENSSL-CONFIG) for SSL configuration instructions.
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/auth-cert.html)（英文原文，待翻譯）
