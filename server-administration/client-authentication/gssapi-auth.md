## 20.6. GSSAPI Authentication [#](#GSSAPI-AUTH)

<a id="id-1.6.7.13.2"></a>

GSSAPI is an industry-standard protocol
for secure authentication defined in
[RFC 2743](https://datatracker.ietf.org/doc/html/rfc2743).
PostgreSQL
...
see [Chapter 17](../installation/README.md) for more information.
...
[krbsrvname](../../client-interfaces/libpq/libpq-connect.md#LIBPQ-CONNECT-KRBSRVNAME) connection parameter.
...
The location of the server's keytab file is specified by the [krb_server_keyfile](../runtime-config/runtime-config-connection.md#GUC-KRB-SERVER-KEYFILE) configuration parameter.
...
server account. (See also [Section 18.1](../runtime/postgres-user.md).)
...
:   If set to 0, the realm name from the authenticated user principal is
    ...
    ([Section 20.2](auth-username-maps.md)). This is discouraged and is
...
:   Allows mapping from client principals to database user names. See
    [Section 20.2](auth-username-maps.md) for details. For a GSSAPI/Kerberos
...
server-wide [krb_caseins_users](../runtime-config/runtime-config-connection.md#GUC-KRB-CASEINS-USERS) configuration
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/gssapi-auth.html)（英文原文，待翻譯）
