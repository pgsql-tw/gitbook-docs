## 20.5. Password Authentication [#](#AUTH-PASSWORD)
...
:   The method `scram-sha-256` performs SCRAM-SHA-256
    ...
    [RFC 7677](https://datatracker.ietf.org/doc/html/rfc7677). It
...
[CREATE ROLE](../../reference/sql-commands/sql-createrole.md) and
...
parameter [password_encryption](../runtime-config/runtime-config-connection.md#GUC-PASSWORD-ENCRYPTION) at the time the
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/auth-password.html)（英文原文，待翻譯）
