...
The `md5` method cannot be used with the [db\_user\_namespace](https://www.postgresql.org/docs/current/runtime-config-connection.html#GUC-DB-USER-NAMESPACE) feature.
