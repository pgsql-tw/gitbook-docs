...
The `md5` method cannot be used with the [db\_user\_namespace](../server-configuration/connections-and-authentication.md#GUC-DB-USER-NAMESPACE) feature.
