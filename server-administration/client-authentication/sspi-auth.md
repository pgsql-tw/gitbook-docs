## 20.7. SSPI Authentication [#](#SSPI-AUTH)
...
GSSAPI does; see [Section 20.6](gssapi-auth.md)
for details.
...
:   Allows for mapping between system and database user names. See
    [Section 20.2](auth-username-maps.md) for details. For an SSPI/Kerberos
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sspi-auth.html)（英文原文，待翻譯）
