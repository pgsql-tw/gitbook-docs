## 20.4. Trust Authentication [#](#AUTH-TRUST)
...
described in [Section 19.3](../runtime-config/runtime-config-connection.md). Or you
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/auth-trust.html)（英文原文，待翻譯）
