## 18.5. Shutting Down the Server [#](#SERVER-SHUTDOWN)
...
The [pg_ctl](../../reference/reference-server/app-pg-ctl.md) program provides a convenient
...
continue, use `pg_terminate_backend()` (see [Table 9.96](../../the-sql-language/functions/functions-admin.md#FUNCTIONS-ADMIN-SIGNAL-TABLE)) or send a
SIGTERM signal to the child process associated with
the session.

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/server-shutdown.html)（英文原文，待翻譯）
