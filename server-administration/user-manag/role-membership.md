## 21.3. Role Membership [#](#ROLE-MEMBERSHIP)
...
[`GRANT`](../../reference/sql-commands/sql-grant.md) and
[`REVOKE`](../../reference/sql-commands/sql-revoke.md) commands:
...
`SET` option can do
[`SET ROLE`](../../reference/sql-commands/sql-set-role.md) to
...
To destroy a group role, use [`DROP ROLE`](../../reference/sql-commands/sql-droprole.md):
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/role-membership.html)（英文原文，待翻譯）
