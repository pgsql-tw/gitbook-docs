## 31.2. Test Evaluation [#](#REGRESS-EVALUATION)
...
[Section 31.3](regress-variant.md) for details.

<a id="REGRESS-EVALUATION-MESSAGE-DIFFERENCES"></a>

### 31.2.1. Error Message Differences [#](#REGRESS-EVALUATION-MESSAGE-DIFFERENCES)
...
### 31.2.2. Locale Differences [#](#REGRESS-EVALUATION-LOCALE-DIFFERENCES)
...
### 31.2.3. Date and Time Differences [#](#REGRESS-EVALUATION-DATE-TIME-DIFFERENCES)
...
### 31.2.4. Floating-Point Differences [#](#REGRESS-EVALUATION-FLOAT-DIFFERENCES)
...
### 31.2.5. Row Ordering Differences [#](#REGRESS-EVALUATION-ORDERING-DIFFERENCES)
...
### 31.2.6. Insufficient Stack Depth [#](#REGRESS-EVALUATION-STACK-DEPTH)
...
[max_stack_depth](../runtime-config/runtime-config-resource.md#GUC-MAX-STACK-DEPTH) parameter indicates. This
...
### 31.2.7. The “random” Test [#](#REGRESS-EVALUATION-RANDOM-TEST)
...
### 31.2.8. Configuration Parameters [#](#REGRESS-EVALUATION-CONFIG-PARAMS)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/regress-evaluation.html)（英文原文，待翻譯）
