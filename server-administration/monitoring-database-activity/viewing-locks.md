...
Details of the `pg_locks` view appear in [Section 54.12](../../internals/system-catalogs/pg_locks.md). For more information on locking and managing concurrency with PostgreSQL, refer to [Chapter 13](../../the-sql-language/concurrency-control/README.md).
