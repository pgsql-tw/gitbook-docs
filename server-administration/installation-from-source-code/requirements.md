...
* You need LZ4, if you want to support compression of data with that method; see [default\_toast\_compression](../server-configuration/client-connection-defaults.md#GUC-DEFAULT-TOAST-COMPRESSION) and [wal\_compression](../server-configuration/write-ahead-log.md#GUC-WAL-COMPRESSION).
* You need Zstandard, if you want to support compression of data with that method; see [wal\_compression](../server-configuration/write-ahead-log.md#GUC-WAL-COMPRESSION). The minimum required version is 1.4.0.
