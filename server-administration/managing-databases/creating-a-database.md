...
In order to create a database, the PostgreSQL server must be up and running (see [Section 19.3](../server-setup-and-operation/starting-the-database-server.md)).

Databases are created with the SQL command [CREATE DATABASE](../../reference/sql-commands/create-database.md):
