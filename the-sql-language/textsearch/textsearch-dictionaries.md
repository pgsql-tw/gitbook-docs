...
[12.6.1. Stop Words](textsearch-dictionaries.md#TEXTSEARCH-STOPWORDS)

[12.6.2. Simple Dictionary](textsearch-dictionaries.md#TEXTSEARCH-SIMPLE-DICTIONARY)

[12.6.3. Synonym Dictionary](textsearch-dictionaries.md#TEXTSEARCH-SYNONYM-DICTIONARY)

[12.6.4. Thesaurus Dictionary](textsearch-dictionaries.md#TEXTSEARCH-THESAURUS)

[12.6.5. Ispell Dictionary](textsearch-dictionaries.md#TEXTSEARCH-ISPELL-DICTIONARY)

[12.6.6. Snowball Dictionary](textsearch-dictionaries.md#TEXTSEARCH-SNOWBALL-DICTIONARY)
...
* If indexing numbers, we can
  ...
  numbers, so for example *3.14*159265359,
  *3.14*15926, *3.14* will be the same
...
letters, as is done by the [unaccent](../../appendixes/contrib/unaccent.md) module.
...
template ([Section 12.6.4](textsearch-dictionaries.md#TEXTSEARCH-THESAURUS)) for that). A synonym
...
[Section 12.3.2](textsearch-controls.md#TEXTSEARCH-PARSING-QUERIES)).
...
Dictionaries for a large number of languages are available from [Ispell](https://www.cs.hmc.edu/~geoff/ispell.html).
Also, some more modern dictionary file formats are supported — [MySpell](https://en.wikipedia.org/wiki/MySpell) (OO < 2.0.1)
and [Hunspell](https://hunspell.github.io/)
...
site](https://snowballstem.org/) for more information). Each algorithm understands how to
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/textsearch-dictionaries.html)（英文原文，待翻譯）
