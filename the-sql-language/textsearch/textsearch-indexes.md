...
searches:
[GIN](../../internals/indextypes/gin.md) and
[GiST](../../internals/indextypes/gist.md).
...
by increasing [maintenance_work_mem](../../server-administration/runtime-config/runtime-config-resource.md#GUC-MAINTENANCE-WORK-MEM), while
...
servers and collecting external search results, e.g., via [Foreign Data](../ddl/ddl-foreign-data.md) access.
The latter is possible because ranking functions use
only local information.

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/textsearch-indexes.html)（英文原文，待翻譯）
