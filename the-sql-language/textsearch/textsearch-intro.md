...
[12.1.1. What Is a Document?](textsearch-intro.md#TEXTSEARCH-DOCUMENT)

[12.1.2. Basic Text Matching](textsearch-intro.md#TEXTSEARCH-MATCHING)

[12.1.3. Configurations](textsearch-intro.md#TEXTSEARCH-INTRO-CONFIGURATIONS)
...
queries ([Section 8.11](../datatype/datatype-textsearch.md)). There are many
functions and operators available for these data types
([Section 9.13](../functions/functions-textsearch.md)), the most important of which is
the match operator `@@`, which we introduce in
[Section 12.1.2](textsearch-intro.md#TEXTSEARCH-MATCHING). Full text searches can be accelerated
using indexes ([Section 12.9](textsearch-indexes.md)).
...
(For syntax details see [Section 8.11.2](../datatype/datatype-textsearch.md#DATATYPE-TSQUERY).) There are
...
[default_text_search_config](../../server-administration/runtime-config/runtime-config-client.md#GUC-DEFAULT-TEXT-SEARCH-CONFIG) is set accordingly
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/textsearch-intro.html)（英文原文，待翻譯）
