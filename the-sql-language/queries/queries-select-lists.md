...
defined in [Section 4.2](../sql-syntax/sql-expressions.md)). For instance, it
...
explained in [Section 7.2.1.2](queries-table-expressions.md#QUERIES-TABLE-ALIASES). The name
...
See [Section 8.16.5](../datatype/rowtypes.md#ROWTYPES-USAGE) for more about
...
avoid ambiguity.
([Appendix C](../../appendixes/sql-keywords-appendix/README.md) shows which key words
...
the `FROM` clause (see [Section 7.2.1.2](queries-table-expressions.md#QUERIES-TABLE-ALIASES)). It is possible
