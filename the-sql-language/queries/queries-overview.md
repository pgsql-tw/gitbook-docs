...
[`SELECT`](../../reference/sql-commands/sql-select.md) command is
...
data type).
See [Section 7.3](queries-select-lists.md) for more details.
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/queries-overview.html)（英文原文，待翻譯）
