...
The [`FROM`](../../reference/sql-commands/sql-select.md#SQL-FROM) clause derives a
...
Cross join <a id="id-1.5.6.6.5.6.4.2.1.1"></a> <a id="id-1.5.6.6.5.6.4.2.1.2"></a>
:   ```
...
Qualified joins <a id="id-1.5.6.6.5.6.4.3.1.1"></a> <a id="id-1.5.6.6.5.6.4.3.1.2"></a>
:   ```
...
column alias names (as in [Section 7.2.1.2](queries-table-expressions.md#QUERIES-TABLE-ALIASES)).
For example:
...
For more information see [Section 7.7](queries-values.md).
...
([Section 9.19](../functions/functions-array.md)) had been called on each parameter
...
The [dblink](../../appendixes/contrib/contrib-dblink-function.md) function
(part of the [dblink](../../appendixes/contrib/dblink.md) module) executes
...
The syntax of the [`WHERE`](../../reference/sql-commands/sql-select.md#SQL-WHERE)
clause is
...
expression (see [Section 4.2](../sql-syntax/sql-expressions.md)) that
...
The [`GROUP BY`](../../reference/sql-commands/sql-select.md#SQL-GROUPBY) clause is
...
about the available aggregate functions can be found in [Section 9.21](../functions/functions-aggregate.md).

### Tip

Grouping without aggregate expressions effectively calculates the
set of distinct values in a column. This can also be achieved
using the `DISTINCT` clause (see [Section 7.3.3](queries-select-lists.md#QUERIES-DISTINCT)).
...
row resulted from, see [Table 9.66](../functions/functions-aggregate.md#FUNCTIONS-GROUPING-TABLE).
...
a [row constructor](../sql-syntax/sql-expressions.md#SQL-SYNTAX-ROW-CONSTRUCTORS).
...
[Section 4.2.8](../sql-syntax/sql-expressions.md#SYNTAX-WINDOW-FUNCTIONS)), these functions are evaluated
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/queries-table-expressions.html)（英文原文，待翻譯）
