...
functions to perform type-safe operations on it; see [Section 9.15](../functions/functions-xml.md). Use of this data type requires the
...
[“document node”](https://www.w3.org/TR/2010/REC-xpath-datamodel-20101214/#DocumentNode)
...
can be found in [Section D.3](../../appendixes/features/xml-limits-conformance.md).
...
use the function
`xmlparse`:<a id="id-1.5.7.21.6.2.3"></a>
...
`xmlserialize`:<a id="id-1.5.7.21.6.4.3"></a>
...
end; see [Section 23.3](../../server-administration/charset/multibyte.md). This includes string
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/datatype-xml.html)（英文原文，待翻譯）
