...
addresses, as shown in [Table 8.21](datatype-net-types.md#DATATYPE-NET-TYPES-TABLE). It
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/datatype-net-types.html)（英文原文，待翻譯）
