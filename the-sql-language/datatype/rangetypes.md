...
see [CREATE TYPE](../../reference/sql-commands/sql-createtype.md) for more information.
...
See [Table 9.58](../functions/functions-range.md#RANGE-OPERATORS-TABLE)
and [Table 9.60](../functions/functions-range.md#RANGE-FUNCTIONS-TABLE) for complete lists of
...
represented by “`)`”.
(See [Section 8.17.5](rangetypes.md#RANGETYPES-IO) for more details.)
...
composite-type literals. See [Section 8.16.6](rowtypes.md#ROWTYPES-IO-SYNTAX) for
...
See [CREATE TYPE](../../reference/sql-commands/sql-createtype.md) for more information about creating
range types.
...
`&<`, and
`&>`.
See [Table 9.58](../functions/functions-range.md#RANGE-OPERATORS-TABLE) for more information.
...
(see [CREATE TABLE
... CONSTRAINT ... EXCLUDE](../../reference/sql-commands/sql-createtable.md#SQL-CREATETABLE-EXCLUDE)). Exclusion constraints allow the
...
You can use the [`btree_gist`](../../appendixes/contrib/btree-gist.md)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/rangetypes.html)（英文原文，待翻譯）
