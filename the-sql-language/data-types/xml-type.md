...
The `xml` data type can be used to store XML data. Its advantage over storing XML data in a `text` field is that it checks the input values for well-formedness, and there are support functions to perform type-safe operations on it; see [Section 9.14](../functions-and-operators/xml.md). Use of this data type requires the installation to have been built with `configure --with-libxml`.
...
Limits and compatibility notes for the `xml` data type can be found in [Section D.3](../../appendixes/d.-sql-xiang-rong-xing/d.3.-xml-limits-and-conformance-to-sql-xml.md).
