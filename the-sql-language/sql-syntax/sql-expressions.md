...
* Another value expression in parentheses (used to group
  ...
  precedence<a id="id-1.5.3.6.6.1.15.1.1"></a>)

In addition to this list, there are a number of constructs that can
be classified as an expression but do not follow any general syntax
rules. These generally have the semantics of a function or
operator and are explained in the appropriate location in [Chapter 9](../functions/README.md). An example is the `IS NULL`
clause.

We have already discussed constants in [Section 4.1.2](sql-syntax-lexical.md#SQL-SYNTAX-CONSTANTS). The following sections discuss
...
is unique across all the tables being used in the current query. (See also [Chapter 7](../queries/README.md).)
...
See [Section 8.15](../datatype/arrays.md) for more about arrays.
...
see [Section 8.16.5](../datatype/rowtypes.md#ROWTYPES-USAGE) for details.
...
<table border="0" class="simplelist" summary="Simple list"><tr><td><em class="replaceable"><code>expression</code></em> <em class="replaceable"><code>operator</code></em> <em class="replaceable"><code>expression</code></em> (binary infix operator)</td></tr><tr><td><em class="replaceable"><code>operator</code></em> <em class="replaceable"><code>expression</code></em> (unary prefix operator)</td></tr></table>

where the *`operator`* token follows the syntax
rules of [Section 4.1.3](sql-syntax-lexical.md#SQL-SYNTAX-OPERATORS), or is one of the
...
defined by the system or the user. [Chapter 9](../functions/README.md)
...
The list of built-in functions is in [Chapter 9](../functions/README.md).
Other functions can be added by the user.

When issuing queries in a database where some users mistrust other users,
observe security precautions from [Section 10.3](../typeconv/typeconv-func.md) when
writing function calls.

The arguments can optionally have names attached.
See [Section 4.3](sql-syntax-calling-funcs.md) for details.
...
[Section 8.16.5](../datatype/rowtypes.md#ROWTYPES-USAGE).
...
described in [Section 7.5](../queries/queries-order.md), except that its expressions
...
The predefined aggregate functions are described in [Section 9.21](../functions/functions-aggregate.md). Other aggregate functions can be added
by the user.
...
[Section 4.2.11](sql-expressions.md#SQL-SYNTAX-SCALAR-SUBQUERIES) and
[Section 9.24](../functions/functions-subquery.md)), the aggregate is normally
...
[SELECT](../../reference/sql-commands/sql-select.md) reference page for details. It's worth
...
The built-in window functions are described in [Table 9.67](../functions/functions-window.md#FUNCTIONS-WINDOW-TABLE). Other window functions can be added by
...
[Section 9.22](../functions/functions-window.md), and
[Section 7.2.5](../queries/queries-table-expressions.md#QUERIES-WINDOW).
...
[Section 4.1.2.7](sql-syntax-lexical.md#SQL-SYNTAX-CONSTANTS-GENERIC). A cast applied to an
...
error. For more details see [Section 23.2](../../server-administration/charset/collation.md).)
...
row with one column. (See [Chapter 7](../queries/README.md) for information about writing queries.)
...
See also [Section 9.24](../functions/functions-subquery.md) for other expressions involving subqueries.
...
`CASE` constructs (see [Section 10.5](../typeconv/typeconv-union-case.md)).
...
For more on casting, see [Section 4.2.9](sql-expressions.md#SQL-SYNTAX-TYPE-CASTS).
...
[Section 8.15](../datatype/arrays.md).
...
of a `SELECT` list (see [Section 8.16.5](../datatype/rowtypes.md#ROWTYPES-USAGE)).
...
using the standard comparison operators as described in [Section 9.2](../functions/functions-comparison.md), to compare one row against another
as described in [Section 9.25](../functions/functions-comparisons.md), and to
use them in connection with subqueries, as discussed in [Section 9.24](../functions/functions-subquery.md).
...
construct (see [Section 9.18](../functions/functions-conditional.md)) can be
...
As described in [Section 36.7](../../server-programming/extend/xfunc-volatility.md), functions and
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-expressions.html)（英文原文，待翻譯）
