...
更多窗函數的說明請參閱 [3.5 節](https://github.com/pgsql-tw/gitbook-docs/blob/15/tutorial/advanced-features/window-functions/README.md)、[9.22 節](https://github.com/pgsql-tw/gitbook-docs/blob/15/the-sql-language/functions-and-operators/window-functions/README.md)、及 [7.2.5 節](https://github.com/pgsql-tw/gitbook-docs/blob/15/the-sql-language/queries/table-expressions/README.md#7.2.5.-chuang-han-shu-chu-li)。
