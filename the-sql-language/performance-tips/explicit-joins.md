...
set by the [geqo_threshold](../../server-administration/runtime-config/runtime-config-query.md#GUC-GEQO-THRESHOLD) run-time
parameter.)
...
`JOIN`s,
set the [join_collapse_limit](../../server-administration/runtime-config/runtime-config-query.md#GUC-JOIN-COLLAPSE-LIMIT) run-time parameter to 1.
...
[from_collapse_limit](../../server-administration/runtime-config/runtime-config-query.md#GUC-FROM-COLLAPSE-LIMIT) and [join_collapse_limit](../../server-administration/runtime-config/runtime-config-query.md#GUC-JOIN-COLLAPSE-LIMIT)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/explicit-joins.html)（英文原文，待翻譯）
