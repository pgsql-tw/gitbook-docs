## 9.29. Trigger Functions [#](#FUNCTIONS-TRIGGER)
...
are summarized in [Table 9.110](functions-trigger.md#BUILTIN-TRIGGERS-TABLE).
...
<p>
        ...
        <a class="xref" href="../textsearch/textsearch-features.md#TEXTSEARCH-UPDATE-TRIGGERS">Section 12.4.3</a> for details.
       </p>
<p>
