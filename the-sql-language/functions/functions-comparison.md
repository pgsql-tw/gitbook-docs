...
The usual comparison operators are available, as shown in [Table 9.1](functions-comparison.md#FUNCTIONS-COMPARISON-OP-TABLE).

<a id="FUNCTIONS-COMPARISON-OP-TABLE"></a>

**Table 9.1. Comparison Operators**

<table border="1" class="table" summary="Comparison Operators"><colgroup><col/><col/></colgroup><thead><tr><th>Operator</th><th>Description</th></tr></thead><tbody><tr><td>
...
There are also some comparison predicates, as shown in [Table 9.2](functions-comparison.md#FUNCTIONS-COMPARISON-PRED-TABLE). These behave much like
...
cannot be done the [transform_null_equals](../../server-administration/runtime-config/runtime-config-compatible.md#GUC-TRANSFORM-NULL-EQUALS)
...
Some comparison-related functions are also available, as shown in [Table 9.3](functions-comparison.md#FUNCTIONS-COMPARISON-FUNC-TABLE).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/functions-comparison.html)（英文原文，待翻譯）
