...
section operate on values of type `xml`. See [Section 8.13](../datatype/datatype-xml.md) for information about the `xml`
...
[xmlbinary](../../server-administration/runtime-config/runtime-config-client.md#GUC-XMLBINARY). The particular behavior for
individual data types is expected to evolve in order to align the
PostgreSQL mappings with those specified in SQL:2006 and later,
as discussed in [Section D.3.1.3](../../appendixes/features/xml-limits-conformance.md#FUNCTIONS-XML-LIMITS-CASTS).
...
See [Section 9.21](functions-aggregate.md) for additional information
...
[Section 4.2.7](../sql-syntax/sql-expressions.md#SYNTAX-AGGREGATES). For example:
...
null. See [Section 8.13](../datatype/datatype-xml.md) about the difference
...
as discussed in [Section D.3.2](../../appendixes/features/xml-limits-conformance.md#FUNCTIONS-XML-LIMITS-POSTGRESQL).
...
[Section D.3.1](../../appendixes/features/xml-limits-conformance.md#FUNCTIONS-XML-LIMITS-XPATH1).
...
the former if the [xmloption](../../server-administration/runtime-config/runtime-config-client.md#GUC-XMLOPTION) configuration
...
[Section D.3.2](../../appendixes/features/xml-limits-conformance.md#FUNCTIONS-XML-LIMITS-POSTGRESQL).
...
[Section D.3.1.2](../../appendixes/features/xml-limits-conformance.md#XML-XPATH-1-SPECIFICS).
...
content form.
[<a id="id-1.5.8.21.7.5.15.2"></a>[8]](#ftn.id-1.5.8.21.7.5.15.2)
...
standard, as discussed in [Section D.3.1.3](../../appendixes/features/xml-limits-conformance.md#FUNCTIONS-XML-LIMITS-CASTS).
...
double quotes (see [Section 8.19](../datatype/datatype-oid.md) for details).
...
[Example 9.1](functions-xml.md#XSLT-XML-HTML) shows an XSLT stylesheet that
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/functions-xml.html)（英文原文，待翻譯）
