...
row. See [Section 3.5](../../tutorial/tutorial-advanced/tutorial-window.md) for an introduction to this
feature, and [Section 4.2.8](../sql-syntax/sql-expressions.md#SYNTAX-WINDOW-FUNCTIONS) for syntax
details.

The built-in window functions are listed in
[Table 9.67](functions-window.md#FUNCTIONS-WINDOW-TABLE). Note that these functions
...
[Section 9.21](functions-aggregate.md) for a list of the built-in aggregates.
...
[Table 9.67](functions-window.md#FUNCTIONS-WINDOW-TABLE) depend on the sort ordering
...
`ROWS` or `GROUPS`) to
the `OVER` clause.
See [Section 4.2.8](../sql-syntax/sql-expressions.md#SYNTAX-WINDOW-FUNCTIONS) for more information
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/functions-window.html)（英文原文，待翻譯）
