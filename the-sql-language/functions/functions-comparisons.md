## 9.25. Row and Array Comparisons [#](#FUNCTIONS-COMPARISONS)
...
### 9.25.3. `ANY`/`SOME` (array) [#](#FUNCTIONS-COMPARISONS-ANY-SOME)
...
### 9.25.4. `ALL` (array) [#](#FUNCTIONS-COMPARISONS-ALL)
...
### 9.25.5. Row Constructor Comparison [#](#ROW-WISE-COMPARISON)
...
### 9.25.6. Composite Type Comparison [#](#COMPOSITE-TYPE-COMPARISON)
...
[Section 9.25.5](functions-comparisons.md#ROW-WISE-COMPARISON)) or comparing a row constructor
to the output of a subquery (as in [Section 9.24](functions-subquery.md)).
...
[Section 9.25.5](functions-comparisons.md#ROW-WISE-COMPARISON)).
...
purposes such as replication and B-Tree deduplication (see [Section 65.1.4.3](../../internals/indextypes/btree.md#BTREE-DEDUPLICATION)). They are not intended to be
generally useful for writing queries, though.

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/functions-comparisons.html)（英文原文，待翻譯）
