...
See [Section 10.5](../typeconv/typeconv-union-case.md) for more details.
...
As described in [Section 4.2.14](../sql-syntax/sql-expressions.md#SYNTAX-EXPRESS-EVAL), there are various
...
[Section 10.5](../typeconv/typeconv-union-case.md) for details).
...
(see [Section 10.5](../typeconv/typeconv-union-case.md) for details).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/functions-conditional.html)（英文原文，待翻譯）
