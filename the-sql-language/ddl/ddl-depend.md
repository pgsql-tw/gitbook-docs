## 5.15. Dependency Tracking [#](#DDL-DEPEND)
...
attempting to drop the products table we considered in [Section 5.5.5](ddl-constraints.md#DDL-CONSTRAINTS-FK), with the orders table depending on
...
(See [Section 36.5](../../server-programming/extend/xfunc-sql.md) for an explanation of SQL-language
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/ddl-depend.html)（英文原文，待翻譯）
