## 5.13. Foreign Data [#](#DDL-FOREIGN-DATA)
...
modules; see [Appendix F](../../appendixes/contrib/README.md). Other kinds of foreign data
wrappers might be found as third party products. If none of the existing
foreign data wrappers suit your needs, you can write your own; see [Chapter 58](../../internals/fdwhandler/README.md).
...
[CREATE FOREIGN TABLE](../../reference/sql-commands/sql-createforeigntable.md), and
[IMPORT FOREIGN SCHEMA](../../reference/sql-commands/sql-importforeignschema.md).

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/ddl-foreign-data.html)（英文原文，待翻譯）
