...
and [non-HOT update](../../internals/storage/storage-hot.md). However, the index expressions are
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/indexes-expressional.html)（英文原文，待翻譯）
