...
illustrated in [Section 14.1](../performance-tips/using-explain.md).
It is also possible to gather overall statistics about index usage
in a running server, as described in [Section 27.2](../../server-administration/monitoring/monitoring-stats.md).
...
* Always run [ANALYZE](../../reference/sql-commands/sql-analyze.md)
  first. This command
  ...
  See [Section 24.1.3](../../server-administration/maintenance/routine-vacuuming.md#VACUUM-FOR-STATISTICS)
...
* When indexes are not used, it can be useful for testing to force
  ...
  various plan types (see [Section 19.7.1](../../server-administration/runtime-config/runtime-config-query.md#RUNTIME-CONFIG-QUERY-ENABLE)).
...
* If it turns out that the cost estimates are wrong, there are,
  ...
  via run-time parameters (described in [Section 19.7.2](../../server-administration/runtime-config/runtime-config-query.md#RUNTIME-CONFIG-QUERY-CONSTANTS)).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/indexes-examine.html)（英文原文，待翻譯）
