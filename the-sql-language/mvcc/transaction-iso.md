...
dirty read <a id="id-1.5.12.5.4.1.1.1.1"></a>
:   A transaction reads data written by a concurrent uncommitted transaction.

nonrepeatable read <a id="id-1.5.12.5.4.1.2.1.1"></a>
:   A transaction re-reads data it has previously read and finds that data
    has been modified by another transaction (that committed since the
    initial read).

phantom read <a id="id-1.5.12.5.4.1.3.1.1"></a>
:   A transaction re-executes a query returning a set of rows that satisfy a
    search condition and finds that the set of rows satisfying the condition
    has changed due to another recently-committed transaction.

serialization anomaly <a id="id-1.5.12.5.4.1.4.1.1"></a>
...
are described in [Table 13.1](transaction-iso.md#MVCC-ISOLEVEL-TABLE).
...
command [SET TRANSACTION](../../reference/sql-commands/sql-set-transaction.md).
...
that made the changes aborts. See [Section 9.17](../functions/functions-sequence.md)
and [Section 8.1.4](../datatype/datatype-numeric.md#DATATYPE-SERIAL).
...
in [Table 13.1](transaction-iso.md#MVCC-ISOLEVEL-TABLE) except for serialization
...
[[berenson95]](../../bibliography.md#BERENSON95).
...
* Don't leave connections dangling “idle in transaction”
  ...
  [idle_in_transaction_session_timeout](../../server-administration/runtime-config/runtime-config-client.md#GUC-IDLE-IN-TRANSACTION-SESSION-TIMEOUT) may be used to
...
* When the system is forced to combine multiple page-level predicate
  ...
  [max_pred_locks_per_transaction](../../server-administration/runtime-config/runtime-config-locks.md#GUC-MAX-PRED-LOCKS-PER-TRANSACTION),
  [max_pred_locks_per_relation](../../server-administration/runtime-config/runtime-config-locks.md#GUC-MAX-PRED-LOCKS-PER-RELATION), and/or
  [max_pred_locks_per_page](../../server-administration/runtime-config/runtime-config-locks.md#GUC-MAX-PRED-LOCKS-PER-PAGE).
* A sequential scan will always necessitate a relation-level predicate
  ...
  [random_page_cost](../../server-administration/runtime-config/runtime-config-query.md#GUC-RANDOM-PAGE-COST) and/or increasing
  [cpu_tuple_cost](../../server-administration/runtime-config/runtime-config-query.md#GUC-CPU-TUPLE-COST). Be sure to weigh any decrease
...
[[ports12]](../../bibliography.md#PORTS12) for detailed information.

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/transaction-iso.html)（英文原文，待翻譯）
