...
- [ ] `server-programming/event-triggers/README.md` — Chapter 38. Event Triggers
...
- [ ] `server-programming/event-triggers/event-trigger-example.md` — 38.3. A Complete Event Trigger Example #
