...
- [x] `bibliography.md` — Bibliography
...
- [x] `appendixes/color/README.md` — Appendix N. Color Support
...
- [x] `appendixes/contrib-prog/vacuumlo.md` — vacuumlo
...
- [x] `appendixes/contrib/contrib-dblink-build-sql-insert.md` — dblink_build_sql_insert
...
- [x] `appendixes/contrib/contrib-dblink-close.md` — dblink_close
- [x] `appendixes/contrib/contrib-dblink-connect-u.md` — dblink_connect_u
- [x] `appendixes/contrib/contrib-dblink-connect.md` — dblink_connect
- [x] `appendixes/contrib/contrib-dblink-disconnect.md` — dblink_disconnect
...
- [x] `appendixes/contrib/contrib-dblink-get-notify.md` — dblink_get_notify
- [x] `appendixes/contrib/contrib-dblink-get-pkey.md` — dblink_get_pkey
- [x] `appendixes/contrib/contrib-dblink-get-result.md` — dblink_get_result
- [x] `appendixes/contrib/contrib-dblink-is-busy.md` — dblink_is_busy
...
- [x] `appendixes/contrib/passwordcheck.md` — F.24. passwordcheck — 驗證密碼強度 #
- [ ] `appendixes/contrib/pgbuffercache.md` — F.25. pg_buffercache — inspect PostgreSQL buffer cache state #
- [ ] `appendixes/contrib/pgcrypto.md` — F.26. pgcrypto — cryptographic functions #
- [ ] `appendixes/contrib/pgfreespacemap.md` — F.27. pg_freespacemap — examine the free space map #
- [ ] `appendixes/contrib/pglogicalinspect.md` — F.28. pg_logicalinspect — logical decoding components inspection #
- [ ] `appendixes/contrib/pgoverexplain.md` — F.29. pg_overexplain — allow EXPLAIN to dump even more details #
- [ ] `appendixes/contrib/pgprewarm.md` — F.30. pg_prewarm — preload relation data into buffer caches #
...
- [ ] `appendixes/contrib/postgres-fdw.md` — F.38. postgres_fdw — access data stored in external PostgreSQL servers #
- [ ] `appendixes/contrib/seg.md` — F.39. seg — a datatype for line segments or floating point intervals #
- [ ] `appendixes/contrib/sepgsql.md` — F.40. sepgsql — SELinux-, label-based mandatory access control (MAC) security module #
- [ ] `appendixes/contrib/sslinfo.md` — F.42. sslinfo — obtain client SSL information #
- [ ] `appendixes/contrib/tablefunc.md` — F.43. tablefunc — functions that return tables ( crosstab and others) #
- [ ] `appendixes/contrib/tcn.md` — F.44. tcn — a trigger function to notify listeners of changes to table content #
- [ ] `appendixes/contrib/test-decoding.md` — F.45. test_decoding — SQL-based test/example module for WAL logical decoding #
- [ ] `appendixes/contrib/tsm-system-rows.md` — F.46. tsm_system_rows — the SYSTEM_ROWS sampling method for TABLESAMPLE #
- [ ] `appendixes/contrib/tsm-system-time.md` — F.47. tsm_system_time — the SYSTEM_TIME sampling method for TABLESAMPLE #
...
- [ ] `appendixes/datetime-appendix/datetime-julian-dates.md` — B.7. Julian Dates #
- [ ] `appendixes/datetime-appendix/datetime-keywords.md` — B.3. Date/Time Key Words #
...
- [x] `appendixes/external-projects/external-admin-tools.md` — H.2. 管理工具
- [x] `appendixes/external-projects/external-extensions.md` — H.4. 擴充套件
- [x] `appendixes/external-projects/external-interfaces.md` — H.1. 用戶端介面
...
- [ ] `appendixes/features/xml-limits-conformance.md` — D.3. XML Limits and Conformance to SQL/XML #
- [ ] `appendixes/glossary/README.md` — Appendix M. Glossary
- [ ] `appendixes/limits/README.md` — Appendix K. PostgreSQL Limits
- [ ] `appendixes/release/README.md` — Appendix E. Release Notes
- [ ] `appendixes/release/release-18-1.md` — E.5. Release 18.1 #
- [ ] `appendixes/release/release-18-2.md` — E.4. Release 18.2 #
- [ ] `appendixes/release/release-18-3.md` — E.3. Release 18.3 #
- [ ] `appendixes/release/release-18-4.md` — E.2. Release 18.4 #
...
- [x] `appendixes/sourcerepo/git.md` — I.1. 透過 Git 取得原始碼
- [ ] `appendixes/sql-keywords-appendix/README.md` — Appendix C. SQL Key Words

## client-interfaces

- [ ] `client-interfaces/README.md` — Part IV. Client Interfaces
- [ ] `client-interfaces/ecpg/README.md` — Chapter 34. ECPG — Embedded SQL in C
- [ ] `client-interfaces/ecpg/ecpg-commands.md` — 34.3. Running SQL Commands #
- [ ] `client-interfaces/ecpg/ecpg-concept.md` — 34.1. The Concept #
- [ ] `client-interfaces/ecpg/ecpg-connect.md` — 34.2. Managing Database Connections #
- [ ] `client-interfaces/ecpg/ecpg-cpp.md` — 34.13. C++ Applications #
- [ ] `client-interfaces/ecpg/ecpg-descriptors.md` — 34.7. Using Descriptor Areas #
- [ ] `client-interfaces/ecpg/ecpg-develop.md` — 34.17. Internals #
- [ ] `client-interfaces/ecpg/ecpg-dynamic.md` — 34.5. Dynamic SQL #
- [ ] `client-interfaces/ecpg/ecpg-errors.md` — 34.8. Error Handling #
...
- [x] `client-interfaces/ecpg/ecpg-sql-allocate-descriptor.md` — ALLOCATE DESCRIPTOR — 配置 SQL 描述區
...
- [ ] `client-interfaces/ecpg/ecpg-sql-disconnect.md` — DISCONNECT
- [ ] `client-interfaces/ecpg/ecpg-sql-execute-immediate.md` — EXECUTE IMMEDIATE
- [ ] `client-interfaces/ecpg/ecpg-sql-get-descriptor.md` — GET DESCRIPTOR
...
- [ ] `client-interfaces/information-schema/infoschema-check-constraint-routine-usage.md` — 35.8. check_constraint_routine_usage #
- [ ] `client-interfaces/information-schema/infoschema-check-constraints.md` — 35.9. check_constraints #
- [ ] `client-interfaces/information-schema/infoschema-collation-character-set-applicab.md` — 35.11. collation_character_set_​applicability #
- [ ] `client-interfaces/information-schema/infoschema-collations.md` — 35.10. collations #
- [ ] `client-interfaces/information-schema/infoschema-column-column-usage.md` — 35.12. column_column_usage #
- [ ] `client-interfaces/information-schema/infoschema-column-domain-usage.md` — 35.13. column_domain_usage #
- [ ] `client-interfaces/information-schema/infoschema-column-options.md` — 35.14. column_options #
- [ ] `client-interfaces/information-schema/infoschema-column-privileges.md` — 35.15. column_privileges #
- [ ] `client-interfaces/information-schema/infoschema-column-udt-usage.md` — 35.16. column_udt_usage #
- [ ] `client-interfaces/information-schema/infoschema-columns.md` — 35.17. columns #
...
- [ ] `client-interfaces/information-schema/infoschema-element-types.md` — 35.24. element_types #
- [x] `client-interfaces/information-schema/infoschema-enabled-roles.md` — 35.25. `enabled_roles`
- [ ] `client-interfaces/information-schema/infoschema-foreign-data-wrapper-options.md` — 35.26. foreign_data_wrapper_options #
- [ ] `client-interfaces/information-schema/infoschema-foreign-data-wrappers.md` — 35.27. foreign_data_wrappers #
- [ ] `client-interfaces/information-schema/infoschema-foreign-server-options.md` — 35.28. foreign_server_options #
...
- [ ] `client-interfaces/information-schema/infoschema-role-column-grants.md` — 35.35. role_column_grants #
- [ ] `client-interfaces/information-schema/infoschema-role-routine-grants.md` — 35.36. role_routine_grants #
- [ ] `client-interfaces/information-schema/infoschema-role-table-grants.md` — 35.37. role_table_grants #
- [ ] `client-interfaces/information-schema/infoschema-role-udt-grants.md` — 35.38. role_udt_grants #
- [ ] `client-interfaces/information-schema/infoschema-role-usage-grants.md` — 35.39. role_usage_grants #
- [ ] `client-interfaces/information-schema/infoschema-routine-column-usage.md` — 35.40. routine_column_usage #
- [ ] `client-interfaces/information-schema/infoschema-routine-privileges.md` — 35.41. routine_privileges #
- [ ] `client-interfaces/information-schema/infoschema-routine-routine-usage.md` — 35.42. routine_routine_usage #
...
- [ ] `client-interfaces/information-schema/infoschema-sql-implementation-info.md` — 35.49. sql_implementation_info #
- [ ] `client-interfaces/information-schema/infoschema-sql-parts.md` — 35.50. sql_parts #
- [ ] `client-interfaces/information-schema/infoschema-sql-sizing.md` — 35.51. sql_sizing #
- [ ] `client-interfaces/information-schema/infoschema-table-constraints.md` — 35.52. table_constraints #
- [ ] `client-interfaces/information-schema/infoschema-table-privileges.md` — 35.53. table_privileges #
- [ ] `client-interfaces/information-schema/infoschema-tables.md` — 35.54. tables #
- [ ] `client-interfaces/information-schema/infoschema-transforms.md` — 35.55. transforms #
- [ ] `client-interfaces/information-schema/infoschema-triggered-update-columns.md` — 35.56. triggered_update_columns #
- [ ] `client-interfaces/information-schema/infoschema-triggers.md` — 35.57. triggers #
- [ ] `client-interfaces/information-schema/infoschema-udt-privileges.md` — 35.58. udt_privileges #
- [ ] `client-interfaces/information-schema/infoschema-usage-privileges.md` — 35.59. usage_privileges #
- [ ] `client-interfaces/information-schema/infoschema-user-defined-types.md` — 35.60. user_defined_types #
- [ ] `client-interfaces/information-schema/infoschema-user-mapping-options.md` — 35.61. user_mapping_options #
- [ ] `client-interfaces/information-schema/infoschema-user-mappings.md` — 35.62. user_mappings #
- [ ] `client-interfaces/information-schema/infoschema-view-column-usage.md` — 35.63. view_column_usage #
- [ ] `client-interfaces/information-schema/infoschema-view-routine-usage.md` — 35.64. view_routine_usage #
- [ ] `client-interfaces/information-schema/infoschema-view-table-usage.md` — 35.65. view_table_usage #
- [ ] `client-interfaces/information-schema/infoschema-views.md` — 35.66. views #
- [ ] `client-interfaces/largeobjects/README.md` — Chapter 33. Large Objects
- [ ] `client-interfaces/largeobjects/lo-examplesect.md` — 33.5. Example Program #
...
- [ ] `client-interfaces/libpq/libpq-cancel.md` — 32.7. Canceling Queries in Progress #
- [ ] `client-interfaces/libpq/libpq-connect.md` — 32.1. Database Connection Control Functions #
- [ ] `client-interfaces/libpq/libpq-control.md` — 32.11. Control Functions #
- [ ] `client-interfaces/libpq/libpq-copy.md` — 32.10. Functions Associated with the COPY Command #
- [ ] `client-interfaces/libpq/libpq-envars.md` — 32.15. Environment Variables #
- [ ] `client-interfaces/libpq/libpq-events.md` — 32.14. Event System #
- [ ] `client-interfaces/libpq/libpq-example.md` — 32.23. Example Programs #
- [ ] `client-interfaces/libpq/libpq-exec.md` — 32.3. Command Execution Functions #
- [ ] `client-interfaces/libpq/libpq-fastpath.md` — 32.8. The Fast-Path Interface #
- [ ] `client-interfaces/libpq/libpq-ldap.md` — 32.18. LDAP Lookup of Connection Parameters #
- [ ] `client-interfaces/libpq/libpq-misc.md` — 32.12. Miscellaneous Functions #
- [ ] `client-interfaces/libpq/libpq-notice-processing.md` — 32.13. Notice Processing #
- [ ] `client-interfaces/libpq/libpq-notify.md` — 32.9. Asynchronous Notification #
- [ ] `client-interfaces/libpq/libpq-oauth.md` — 32.20. OAuth Support #
- [ ] `client-interfaces/libpq/libpq-pgpass.md` — 32.16. The Password File #
- [ ] `client-interfaces/libpq/libpq-pgservice.md` — 32.17. The Connection Service File #
- [ ] `client-interfaces/libpq/libpq-pipeline-mode.md` — 32.5. Pipeline Mode #
- [ ] `client-interfaces/libpq/libpq-single-row-mode.md` — 32.6. Retrieving Query Results in Chunks #
- [ ] `client-interfaces/libpq/libpq-ssl.md` — 32.19. SSL Support #
- [ ] `client-interfaces/libpq/libpq-status.md` — 32.2. Connection Status Functions #
- [ ] `client-interfaces/libpq/libpq-threading.md` — 32.21. Behavior in Threaded Programs #
...
- [ ] `internals/catalogs/catalog-pg-aggregate.md` — 52.2. pg_aggregate #
- [ ] `internals/catalogs/catalog-pg-am.md` — 52.3. pg_am #
- [ ] `internals/catalogs/catalog-pg-amop.md` — 52.4. pg_amop #
- [ ] `internals/catalogs/catalog-pg-amproc.md` — 52.5. pg_amproc #
- [ ] `internals/catalogs/catalog-pg-attrdef.md` — 52.6. pg_attrdef #
- [ ] `internals/catalogs/catalog-pg-attribute.md` — 52.7. pg_attribute #
- [ ] `internals/catalogs/catalog-pg-auth-members.md` — 52.9. pg_auth_members #
- [ ] `internals/catalogs/catalog-pg-authid.md` — 52.8. pg_authid #
- [ ] `internals/catalogs/catalog-pg-cast.md` — 52.10. pg_cast #
- [ ] `internals/catalogs/catalog-pg-class.md` — 52.11. pg_class #
- [ ] `internals/catalogs/catalog-pg-collation.md` — 52.12. pg_collation #
- [ ] `internals/catalogs/catalog-pg-constraint.md` — 52.13. pg_constraint #
- [ ] `internals/catalogs/catalog-pg-conversion.md` — 52.14. pg_conversion #
- [ ] `internals/catalogs/catalog-pg-database.md` — 52.15. pg_database #
- [ ] `internals/catalogs/catalog-pg-db-role-setting.md` — 52.16. pg_db_role_setting #
- [ ] `internals/catalogs/catalog-pg-default-acl.md` — 52.17. pg_default_acl #
- [ ] `internals/catalogs/catalog-pg-depend.md` — 52.18. pg_depend #
- [ ] `internals/catalogs/catalog-pg-description.md` — 52.19. pg_description #
- [ ] `internals/catalogs/catalog-pg-enum.md` — 52.20. pg_enum #
- [ ] `internals/catalogs/catalog-pg-event-trigger.md` — 52.21. pg_event_trigger #
- [ ] `internals/catalogs/catalog-pg-extension.md` — 52.22. pg_extension #
- [ ] `internals/catalogs/catalog-pg-foreign-data-wrapper.md` — 52.23. pg_foreign_data_wrapper #
- [ ] `internals/catalogs/catalog-pg-foreign-server.md` — 52.24. pg_foreign_server #
- [ ] `internals/catalogs/catalog-pg-foreign-table.md` — 52.25. pg_foreign_table #
- [ ] `internals/catalogs/catalog-pg-index.md` — 52.26. pg_index #
- [ ] `internals/catalogs/catalog-pg-inherits.md` — 52.27. pg_inherits #
- [ ] `internals/catalogs/catalog-pg-init-privs.md` — 52.28. pg_init_privs #
- [ ] `internals/catalogs/catalog-pg-language.md` — 52.29. pg_language #
- [ ] `internals/catalogs/catalog-pg-largeobject-metadata.md` — 52.31. pg_largeobject_metadata #
- [ ] `internals/catalogs/catalog-pg-largeobject.md` — 52.30. pg_largeobject #
- [ ] `internals/catalogs/catalog-pg-namespace.md` — 52.32. pg_namespace #
- [ ] `internals/catalogs/catalog-pg-opclass.md` — 52.33. pg_opclass #
- [ ] `internals/catalogs/catalog-pg-operator.md` — 52.34. pg_operator #
- [ ] `internals/catalogs/catalog-pg-opfamily.md` — 52.35. pg_opfamily #
- [ ] `internals/catalogs/catalog-pg-parameter-acl.md` — 52.36. pg_parameter_acl #
- [ ] `internals/catalogs/catalog-pg-partitioned-table.md` — 52.37. pg_partitioned_table #
- [ ] `internals/catalogs/catalog-pg-policy.md` — 52.38. pg_policy #
- [ ] `internals/catalogs/catalog-pg-proc.md` — 52.39. pg_proc #
- [ ] `internals/catalogs/catalog-pg-publication-namespace.md` — 52.41. pg_publication_namespace #
- [ ] `internals/catalogs/catalog-pg-publication-rel.md` — 52.42. pg_publication_rel #
- [ ] `internals/catalogs/catalog-pg-publication.md` — 52.40. pg_publication #
- [ ] `internals/catalogs/catalog-pg-range.md` — 52.43. pg_range #
...
- [ ] `internals/catalogs/catalog-pg-statistic-ext-data.md` — 52.53. pg_statistic_ext_data #
- [ ] `internals/catalogs/catalog-pg-statistic-ext.md` — 52.52. pg_statistic_ext #
- [ ] `internals/catalogs/catalog-pg-statistic.md` — 52.51. pg_statistic #
- [ ] `internals/catalogs/catalog-pg-subscription-rel.md` — 52.55. pg_subscription_rel #
- [ ] `internals/catalogs/catalog-pg-subscription.md` — 52.54. pg_subscription #
- [ ] `internals/catalogs/catalog-pg-tablespace.md` — 52.56. pg_tablespace #
- [ ] `internals/catalogs/catalog-pg-transform.md` — 52.57. pg_transform #
- [ ] `internals/catalogs/catalog-pg-trigger.md` — 52.58. pg_trigger #
- [ ] `internals/catalogs/catalog-pg-ts-config-map.md` — 52.60. pg_ts_config_map #
- [ ] `internals/catalogs/catalog-pg-ts-config.md` — 52.59. pg_ts_config #
- [ ] `internals/catalogs/catalog-pg-ts-dict.md` — 52.61. pg_ts_dict #
- [ ] `internals/catalogs/catalog-pg-ts-parser.md` — 52.62. pg_ts_parser #
- [ ] `internals/catalogs/catalog-pg-ts-template.md` — 52.63. pg_ts_template #
- [ ] `internals/catalogs/catalog-pg-type.md` — 52.64. pg_type #
- [ ] `internals/catalogs/catalog-pg-user-mapping.md` — 52.65. pg_user_mapping #
- [ ] `internals/catalogs/catalogs-overview.md` — 52.1. Overview #
- [ ] `internals/custom-scan/README.md` — Chapter 60. Writing a Custom Scan Provider
- [ ] `internals/custom-scan/custom-scan-execution.md` — 60.3. Executing Custom Scans #
- [ ] `internals/custom-scan/custom-scan-path.md` — 60.1. Creating Custom Scan Paths #
- [ ] `internals/custom-scan/custom-scan-plan.md` — 60.2. Creating Custom Scan Plans #
- [ ] `internals/fdwhandler/README.md` — Chapter 58. Writing a Foreign Data Wrapper
- [ ] `internals/fdwhandler/fdw-callbacks.md` — 58.2. Foreign Data Wrapper Callback Routines #
- [ ] `internals/fdwhandler/fdw-functions.md` — 58.1. Foreign Data Wrapper Functions #
...
- [ ] `internals/indexam/index-cost-estimation.md` — 63.6. Index Cost Estimation Functions #
- [ ] `internals/indexam/index-functions.md` — 63.2. Index Access Method Functions #
- [ ] `internals/indexam/index-locking.md` — 63.4. Index Locking Considerations #
- [ ] `internals/indexam/index-scanning.md` — 63.3. Index Scanning #
- [ ] `internals/indexam/index-unique-checks.md` — 63.5. Index Uniqueness Checks #
- [ ] `internals/indextypes/README.md` — Chapter 65. Built-in Index Access Methods
- [ ] `internals/indextypes/brin.md` — 65.5. BRIN Indexes #
- [ ] `internals/indextypes/btree.md` — 65.1. B-Tree Indexes #
- [ ] `internals/indextypes/gin.md` — 65.4. GIN Indexes #
...
- [ ] `internals/plhandler/README.md` — Chapter 57. Writing a Procedural Language Handler
- [ ] `internals/protocol/README.md` — Chapter 54. Frontend/Backend Protocol
- [ ] `internals/protocol/protocol-changes.md` — 54.10. Summary of Changes since Protocol 2.0 #
- [ ] `internals/protocol/protocol-error-fields.md` — 54.8. Error and Notice Message Fields #
- [ ] `internals/protocol/protocol-flow.md` — 54.2. Message Flow #
- [ ] `internals/protocol/protocol-logical-replication.md` — 54.5. Logical Streaming Replication Protocol #
- [ ] `internals/protocol/protocol-logicalrep-message-formats.md` — 54.9. Logical Replication Message Formats #
- [ ] `internals/protocol/protocol-message-formats.md` — 54.7. Message Formats #
- [ ] `internals/protocol/protocol-message-types.md` — 54.6. Message Data Types #
...
- [ ] `internals/source/source-format.md` — 55.1. Formatting #
- [x] `internals/storage/README.md` — 第 66 章 資料庫實體儲存
- [ ] `internals/storage/storage-file-layout.md` — 66.1. Database File Layout #
- [x] `internals/storage/storage-fsm.md` — 66.3. 可用空間對應表
...
- [ ] `internals/views/view-pg-hba-file-rules.md` — 53.10. pg_hba_file_rules #
- [ ] `internals/views/view-pg-ident-file-mappings.md` — 53.11. pg_ident_file_mappings #
- [ ] `internals/views/view-pg-indexes.md` — 53.12. pg_indexes #
- [ ] `internals/views/view-pg-locks.md` — 53.13. pg_locks #
- [ ] `internals/views/view-pg-matviews.md` — 53.14. pg_matviews #
- [ ] `internals/views/view-pg-policies.md` — 53.15. pg_policies #
- [ ] `internals/views/view-pg-prepared-statements.md` — 53.16. pg_prepared_statements #
- [ ] `internals/views/view-pg-prepared-xacts.md` — 53.17. pg_prepared_xacts #
- [ ] `internals/views/view-pg-publication-tables.md` — 53.18. pg_publication_tables #
- [ ] `internals/views/view-pg-replication-origin-status.md` — 53.19. pg_replication_origin_status #
- [ ] `internals/views/view-pg-replication-slots.md` — 53.20. pg_replication_slots #
- [ ] `internals/views/view-pg-roles.md` — 53.21. pg_roles #
- [ ] `internals/views/view-pg-rules.md` — 53.22. pg_rules #
- [ ] `internals/views/view-pg-seclabels.md` — 53.23. pg_seclabels #
- [ ] `internals/views/view-pg-sequences.md` — 53.24. pg_sequences #
- [ ] `internals/views/view-pg-settings.md` — 53.25. pg_settings #
- [ ] `internals/views/view-pg-shadow.md` — 53.26. pg_shadow #
- [ ] `internals/views/view-pg-shmem-allocations-numa.md` — 53.28. pg_shmem_allocations_numa #
- [ ] `internals/views/view-pg-shmem-allocations.md` — 53.27. pg_shmem_allocations #
- [ ] `internals/views/view-pg-stats-ext-exprs.md` — 53.31. pg_stats_ext_exprs #
- [ ] `internals/views/view-pg-stats-ext.md` — 53.30. pg_stats_ext #
...
- [ ] `reference/README.md` — Part VI. Reference
- [ ] `reference/reference-client/README.md` — PostgreSQL Client Applications
- [ ] `reference/reference-client/app-clusterdb.md` — clusterdb
- [ ] `reference/reference-client/app-createdb.md` — createdb
- [ ] `reference/reference-client/app-createuser.md` — createuser
- [ ] `reference/reference-client/app-dropdb.md` — dropdb
- [ ] `reference/reference-client/app-dropuser.md` — dropuser
- [ ] `reference/reference-client/app-ecpg.md` — ecpg
- [ ] `reference/reference-client/app-pg-dumpall.md` — pg_dumpall
- [ ] `reference/reference-client/app-pg-isready.md` — pg_isready
- [ ] `reference/reference-client/app-pgamcheck.md` — pg_amcheck
- [ ] `reference/reference-client/app-pgbasebackup.md` — pg_basebackup
- [ ] `reference/reference-client/app-pgcombinebackup.md` — pg_combinebackup
- [ ] `reference/reference-client/app-pgconfig.md` — pg_config
- [ ] `reference/reference-client/app-pgdump.md` — pg_dump
- [ ] `reference/reference-client/app-pgreceivewal.md` — pg_receivewal
- [ ] `reference/reference-client/app-pgrecvlogical.md` — pg_recvlogical
- [ ] `reference/reference-client/app-pgrestore.md` — pg_restore
- [ ] `reference/reference-client/app-pgverifybackup.md` — pg_verifybackup
- [ ] `reference/reference-client/app-psql.md` — psql
- [ ] `reference/reference-client/app-reindexdb.md` — reindexdb
- [ ] `reference/reference-client/app-vacuumdb.md` — vacuumdb
- [ ] `reference/reference-client/pgbench.md` — pgbench
- [ ] `reference/reference-server/README.md` — PostgreSQL Server Applications
...
- [ ] `reference/reference-server/app-pgwalsummary.md` — pg_walsummary
- [ ] `reference/reference-server/app-postgres.md` — postgres
- [ ] `reference/reference-server/pgarchivecleanup.md` — pg_archivecleanup
- [ ] `reference/reference-server/pgtestfsync.md` — pg_test_fsync
- [ ] `reference/reference-server/pgtesttiming.md` — pg_test_timing
- [ ] `reference/reference-server/pgupgrade.md` — pg_upgrade
- [ ] `reference/reference-server/pgwaldump.md` — pg_waldump
- [ ] `reference/sql-commands/README.md` — SQL Commands
- [ ] `reference/sql-commands/sql-abort.md` — ABORT
- [ ] `reference/sql-commands/sql-alteraggregate.md` — ALTER AGGREGATE
- [ ] `reference/sql-commands/sql-altercollation.md` — ALTER COLLATION
- [ ] `reference/sql-commands/sql-alterconversion.md` — ALTER CONVERSION
- [ ] `reference/sql-commands/sql-alterdatabase.md` — ALTER DATABASE
- [ ] `reference/sql-commands/sql-alterdefaultprivileges.md` — ALTER DEFAULT PRIVILEGES
- [ ] `reference/sql-commands/sql-alterdomain.md` — ALTER DOMAIN
- [ ] `reference/sql-commands/sql-altereventtrigger.md` — ALTER EVENT TRIGGER
- [ ] `reference/sql-commands/sql-alterextension.md` — ALTER EXTENSION
- [ ] `reference/sql-commands/sql-alterforeigndatawrapper.md` — ALTER FOREIGN DATA WRAPPER
- [ ] `reference/sql-commands/sql-alterforeigntable.md` — ALTER FOREIGN TABLE
- [ ] `reference/sql-commands/sql-alterfunction.md` — ALTER FUNCTION
...
- [ ] `reference/sql-commands/sql-alteropfamily.md` — ALTER OPERATOR FAMILY
- [ ] `reference/sql-commands/sql-alterpolicy.md` — ALTER POLICY
- [ ] `reference/sql-commands/sql-alterprocedure.md` — ALTER PROCEDURE
...
- [x] `reference/sql-commands/sql-alterschema.md` — ALTER SCHEMA — 變更 schema 的定義
- [ ] `reference/sql-commands/sql-altersequence.md` — ALTER SEQUENCE
- [ ] `reference/sql-commands/sql-alterserver.md` — ALTER SERVER
- [ ] `reference/sql-commands/sql-alterstatistics.md` — ALTER STATISTICS
- [ ] `reference/sql-commands/sql-altersubscription.md` — ALTER SUBSCRIPTION
- [ ] `reference/sql-commands/sql-altersystem.md` — ALTER SYSTEM
- [ ] `reference/sql-commands/sql-altertable.md` — ALTER TABLE
- [ ] `reference/sql-commands/sql-altertablespace.md` — ALTER TABLESPACE
...
- [x] `reference/sql-commands/sql-altertstemplate.md` — ALTER TEXT SEARCH TEMPLATE — 變更文本搜尋模板的定義
- [ ] `reference/sql-commands/sql-altertype.md` — ALTER TYPE
- [ ] `reference/sql-commands/sql-alteruser.md` — ALTER USER
- [ ] `reference/sql-commands/sql-alterusermapping.md` — ALTER USER MAPPING
- [ ] `reference/sql-commands/sql-alterview.md` — ALTER VIEW
- [ ] `reference/sql-commands/sql-analyze.md` — ANALYZE
- [ ] `reference/sql-commands/sql-begin.md` — BEGIN
- [ ] `reference/sql-commands/sql-call.md` — CALL
- [ ] `reference/sql-commands/sql-checkpoint.md` — CHECKPOINT
- [ ] `reference/sql-commands/sql-close.md` — CLOSE
- [ ] `reference/sql-commands/sql-cluster.md` — CLUSTER
- [ ] `reference/sql-commands/sql-comment.md` — COMMENT
- [ ] `reference/sql-commands/sql-commit-prepared.md` — COMMIT PREPARED
- [ ] `reference/sql-commands/sql-commit.md` — COMMIT
- [ ] `reference/sql-commands/sql-copy.md` — COPY
- [ ] `reference/sql-commands/sql-create-access-method.md` — CREATE ACCESS METHOD
- [ ] `reference/sql-commands/sql-createaggregate.md` — CREATE AGGREGATE
- [ ] `reference/sql-commands/sql-createcast.md` — CREATE CAST
- [ ] `reference/sql-commands/sql-createcollation.md` — CREATE COLLATION
- [ ] `reference/sql-commands/sql-createconversion.md` — CREATE CONVERSION
- [ ] `reference/sql-commands/sql-createdatabase.md` — CREATE DATABASE
- [ ] `reference/sql-commands/sql-createdomain.md` — CREATE DOMAIN
- [ ] `reference/sql-commands/sql-createeventtrigger.md` — CREATE EVENT TRIGGER
- [ ] `reference/sql-commands/sql-createextension.md` — CREATE EXTENSION
...
- [ ] `reference/sql-commands/sql-createprocedure.md` — CREATE PROCEDURE
- [ ] `reference/sql-commands/sql-createpublication.md` — CREATE PUBLICATION
- [ ] `reference/sql-commands/sql-createrole.md` — CREATE ROLE
- [ ] `reference/sql-commands/sql-createrule.md` — CREATE RULE
- [ ] `reference/sql-commands/sql-createschema.md` — CREATE SCHEMA
- [ ] `reference/sql-commands/sql-createsequence.md` — CREATE SEQUENCE
- [ ] `reference/sql-commands/sql-createserver.md` — CREATE SERVER
- [ ] `reference/sql-commands/sql-createstatistics.md` — CREATE STATISTICS
...
- [ ] `reference/sql-commands/sql-createtransform.md` — CREATE TRANSFORM
- [ ] `reference/sql-commands/sql-createtrigger.md` — CREATE TRIGGER
- [ ] `reference/sql-commands/sql-createtsconfig.md` — CREATE TEXT SEARCH CONFIGURATION
- [ ] `reference/sql-commands/sql-createtsdictionary.md` — CREATE TEXT SEARCH DICTIONARY
...
- [ ] `reference/sql-commands/sql-importforeignschema.md` — IMPORT FOREIGN SCHEMA
- [ ] `reference/sql-commands/sql-insert.md` — INSERT
- [ ] `reference/sql-commands/sql-listen.md` — LISTEN
- [ ] `reference/sql-commands/sql-load.md` — LOAD
- [ ] `reference/sql-commands/sql-lock.md` — LOCK
- [ ] `reference/sql-commands/sql-merge.md` — MERGE
- [ ] `reference/sql-commands/sql-move.md` — MOVE
...
- [ ] `reference/sql-commands/sql-rollback-prepared.md` — ROLLBACK PREPARED
...
- [ ] `reference/sql-commands/sql-set-session-authorization.md` — SET SESSION AUTHORIZATION
...
- [ ] `reference/sql-commands/sql-truncate.md` — TRUNCATE
- [ ] `reference/sql-commands/sql-unlisten.md` — UNLISTEN
- [ ] `reference/sql-commands/sql-update.md` — UPDATE
...
- [x] `server-administration/client-authentication/auth-radius.md` — 20.11. RADIUS 驗證 #
...
- [x] `server-administration/high-availability/different-replication-solutions.md` — 26.1. 各種解決方案比較 #
...
- [x] `server-administration/installation/install-make.md` — 17.3. 以 Autoconf 與 Make 建置與安裝 #
- [x] `server-administration/installation/install-meson.md` — 17.4. 使用 Meson 建置與安裝 #
- [x] `server-administration/installation/install-post.md` — 17.5. 安裝後設定 #
- [x] `server-administration/installation/install-requirements.md` — 17.1. 需求 #
- [ ] `server-administration/installation/installation-platform-notes.md` — 17.7. Platform-Specific Notes #
- [x] `server-administration/installation/supported-platforms.md` — 17.6. 受支援的平台 #
- [x] `server-administration/jit/README.md` — 第 30 章 即時編譯（JIT）
- [x] `server-administration/jit/jit-configuration.md` — 30.3. 設定
- [x] `server-administration/jit/jit-decision.md` — 30.2. 何時該使用 JIT？ #
- [x] `server-administration/jit/jit-extensibility.md` — 30.4. 可擴充性 #
- [x] `server-administration/jit/jit-reason.md` — 30.1. 什麼是 JIT 編譯？ #
- [ ] `server-administration/logical-replication/README.md` — Chapter 29. Logical Replication
...
- [x] `server-administration/maintenance/routine-reindex.md` — 24.2. 例行重新建立索引 #
...
- [x] `server-administration/managing-databases/manage-ag-config.md` — 22.4. 資料庫設定
- [x] `server-administration/managing-databases/manage-ag-createdb.md` — 22.2. 建立資料庫 #
...
- [x] `server-administration/runtime-config/runtime-config-developer.md` — 19.17. 開發人員選項 #
...
- [x] `server-administration/runtime-config/runtime-config-locks.md` — 19.12. 鎖定管理 #
- [ ] `server-administration/runtime-config/runtime-config-logging.md` — 19.8. Error Reporting and Logging #
- [x] `server-administration/runtime-config/runtime-config-preset.md` — 19.15. 預設選項 #
- [x] `server-administration/runtime-config/runtime-config-query.md` — 19.7. 查詢規劃 #
- [x] `server-administration/runtime-config/runtime-config-replication.md` — 19.6. 複寫 #
- [x] `server-administration/runtime-config/runtime-config-resource.md` — 19.4. 資源消耗 #
...
- [x] `server-administration/runtime-config/runtime-config-wal.md` — 19.5. 預寫式日誌 (WAL) #
...
- [x] `server-administration/runtime/server-start.md` — 18.3. 啟動資料庫伺服器 #
- [x] `server-administration/runtime/ssh-tunnels.md` — 18.11. 使用 SSH 通道的安全 TCP/IP 連線 #
- [x] `server-administration/runtime/ssl-tcp.md` — 18.9. 使用 SSL 的安全 TCP/IP 連線 #
- [x] `server-administration/runtime/upgrading.md` — 18.6. 升級 PostgreSQL 叢集 #
...
- [x] `server-administration/wal/wal-async-commit.md` — 28.4. 非同步確認 #
...
- [x] `server-programming/README.md` — 第五部分：伺服器程式設計
- [x] `server-programming/archive-modules/README.md` — 第 49 章 封存模組
...
- [x] `server-programming/event-triggers/event-trigger-table-rewrite-example.md` — 38.4. 資料表重寫事件觸發程序範例 #
- [x] `server-programming/extend/README.md` — 第 36 章 擴充 SQL
- [x] `server-programming/extend/extend-extensions.md` — 36.17. 將相關物件封裝成擴充功能 #
- [x] `server-programming/extend/extend-how.md` — 36.1. 擴充性的運作方式 #
...
- [x] `server-programming/extend/xfunc-sql.md` — 36.5. 查詢語言（SQL）函式 #
- [x] `server-programming/extend/xfunc-volatility.md` — 36.7. 函式揮發性類別 #
...
- [x] `server-programming/extend/xoper-optimization.md` — 36.15. 運算子最佳化資訊 #
...
- [x] `server-programming/logicaldecoding/README.md` — 第 47 章 邏輯解碼
...
- [x] `server-programming/oauth-validators/README.md` — 第 50 章 OAuth 驗證器模組
- [x] `server-programming/oauth-validators/oauth-validator-callbacks.md` — 50.3. OAuth 驗證器回呼函式 #
- [x] `server-programming/oauth-validators/oauth-validator-design.md` — 50.1. 安全地設計驗證器模組 #
- [x] `server-programming/oauth-validators/oauth-validator-init.md` — 50.2. 初始化函式 #
...
- [x] `server-programming/plperl/plperl-under-the-hood.md` — 43.8. PL/Perl 內部運作原理 #
- [x] `server-programming/plpgsql/README.md` — 第 41 章 PL/pgSQL — SQL 程序語言
- [x] `server-programming/plpgsql/plpgsql-control-structures.md` — 41.6. 控制結構 #
- [x] `server-programming/plpgsql/plpgsql-cursors.md` — 41.7. 游標 #
- [x] `server-programming/plpgsql/plpgsql-declarations.md` — 41.3. 宣告 #
...
- [x] `server-programming/plpgsql/plpgsql-implementation.md` — 41.11. PL/pgSQL 內部運作原理 #
- [x] `server-programming/plpgsql/plpgsql-overview.md` — 41.1. 概觀 #
- [x] `server-programming/plpgsql/plpgsql-porting.md` — 41.13. 從 Oracle PL/SQL 移植 #
- [x] `server-programming/plpgsql/plpgsql-statements.md` — 41.5. 基本陳述式 #
- [x] `server-programming/plpgsql/plpgsql-structure.md` — 41.2. PL/pgSQL 的結構 #
- [x] `server-programming/plpgsql/plpgsql-transactions.md` — 41.8. 交易管理 #
- [x] `server-programming/plpgsql/plpgsql-trigger.md` — 41.10. 觸發程序函式 #
- [x] `server-programming/plpython/README.md` — 第 44 章 PL/Python — Python 程序語言
...
- [x] `server-programming/plpython/plpython-trigger.md` — 44.5. 觸發程序函式 #
- [x] `server-programming/plpython/plpython-util.md` — 44.9. 公用函式 #
- [x] `server-programming/pltcl/README.md` — 第 42 章 PL/Tcl — Tcl 程序語言
- [x] `server-programming/pltcl/pltcl-config.md` — 42.11. PL/Tcl 組態設定 #
- [x] `server-programming/pltcl/pltcl-data.md` — 42.3. PL/Tcl 中的資料值
- [x] `server-programming/pltcl/pltcl-dbaccess.md` — 42.5. 從 PL/Tcl 存取資料庫 #
- [x] `server-programming/pltcl/pltcl-error-handling.md` — 42.8. PL/Tcl 中的錯誤處理 #
- [x] `server-programming/pltcl/pltcl-event-trigger.md` — 42.7. PL/Tcl 中的事件觸發器函式
- [x] `server-programming/pltcl/pltcl-functions.md` — 42.2. PL/Tcl 函式與引數 #
- [x] `server-programming/pltcl/pltcl-global.md` — 42.4. PL/Tcl 中的全域資料 #
- [x] `server-programming/pltcl/pltcl-overview.md` — 42.1. 概觀 #
...
- [x] `server-programming/rules/rules-materializedviews.md` — 39.3. 具體化檢視表 #
- [x] `server-programming/rules/rules-privileges.md` — 39.5. 規則與權限 #
- [x] `server-programming/rules/rules-status.md` — 39.6. 規則與指令狀態 #
- [x] `server-programming/rules/rules-triggers.md` — 39.7. 規則與觸發程序的比較 #
- [x] `server-programming/rules/rules-update.md` — 39.4. `INSERT`、`UPDATE` 與 `DELETE` 上的規則 #
- [x] `server-programming/rules/rules-views.md` — 39.2. 檢視表與規則系統 #
- [x] `server-programming/spi/README.md` — 第 45 章 伺服器程式設計介面
- [x] `server-programming/spi/spi-examples.md` — 45.6. 範例 #
- [x] `server-programming/spi/spi-interface-support.md` — 45.2. 介面支援函式
- [x] `server-programming/spi/spi-interface.md` — 45.1. 介面函式 #
- [x] `server-programming/spi/spi-memory.md` — 45.3. 記憶體管理 #
- [x] `server-programming/spi/spi-realloc.md` — SPI_repalloc
- [x] `server-programming/spi/spi-spi-commit.md` — SPI_commit
- [x] `server-programming/spi/spi-spi-connect.md` — SPI_connect、SPI_connect_ext
- [x] `server-programming/spi/spi-spi-copytuple.md` — SPI_copytuple
- [x] `server-programming/spi/spi-spi-cursor-close.md` — SPI_cursor_close
- [x] `server-programming/spi/spi-spi-cursor-fetch.md` — SPI_cursor_fetch
...
- [x] `server-programming/spi/spi-spi-cursor-open.md` — SPI_cursor_open
- [x] `server-programming/spi/spi-spi-cursor-parse-open.md` — SPI_cursor_parse_open
- [x] `server-programming/spi/spi-spi-exec.md` — SPI_exec
- [x] `server-programming/spi/spi-spi-execp.md` — SPI_execp
- [x] `server-programming/spi/spi-spi-execute-extended.md` — SPI_execute_extended
- [x] `server-programming/spi/spi-spi-execute-plan-extended.md` — SPI_execute_plan_extended
- [x] `server-programming/spi/spi-spi-execute-plan-with-paramlist.md` — SPI_execute_plan_with_paramlist
- [x] `server-programming/spi/spi-spi-execute-plan.md` — SPI_execute_plan
- [x] `server-programming/spi/spi-spi-execute-with-args.md` — SPI_execute_with_args
- [x] `server-programming/spi/spi-spi-execute.md` — SPI_execute
...
- [x] `server-programming/spi/spi-spi-freetupletable.md` — SPI_freetuptable
- [x] `server-programming/spi/spi-spi-getargcount.md` — SPI_getargcount
- [x] `server-programming/spi/spi-spi-getargtypeid.md` — SPI_getargtypeid
- [x] `server-programming/spi/spi-spi-getbinval.md` — SPI_getbinval
- [x] `server-programming/spi/spi-spi-getnspname.md` — SPI_getnspname
- [x] `server-programming/spi/spi-spi-getrelname.md` — SPI_getrelname
- [x] `server-programming/spi/spi-spi-gettype.md` — SPI_gettype
- [x] `server-programming/spi/spi-spi-gettypeid.md` — SPI_gettypeid
- [x] `server-programming/spi/spi-spi-getvalue.md` — SPI_getvalue
- [x] `server-programming/spi/spi-spi-is-cursor-plan.md` — SPI_is_cursor_plan
- [x] `server-programming/spi/spi-spi-keepplan.md` — SPI_keepplan
- [x] `server-programming/spi/spi-spi-modifytuple.md` — SPI_modifytuple
...
- [x] `server-programming/spi/spi-spi-prepare-extended.md` — SPI_prepare_extended
- [x] `server-programming/spi/spi-spi-prepare-params.md` — SPI_prepare_params
- [x] `server-programming/spi/spi-spi-prepare.md` — SPI_prepare
- [x] `server-programming/spi/spi-spi-register-relation.md` — SPI_register_relation
- [x] `server-programming/spi/spi-spi-register-trigger-data.md` — SPI_register_trigger_data
- [x] `server-programming/spi/spi-spi-result-code-string.md` — SPI_result_code_string
- [x] `server-programming/spi/spi-spi-returntuple.md` — SPI_returntuple
...
- [x] `server-programming/triggers/trigger-interface.md` — 37.3. 以 C 撰寫觸發程序函式 #
- [x] `server-programming/xplang/README.md` — 第 40 章 程序語言
- [x] `server-programming/xplang/xplang-install.md` — 40.1. 安裝程序語言 #

## the-sql-language

- [x] `the-sql-language/README.md` — 第二部分：SQL 語言
- [x] `the-sql-language/datatype/README.md` — 第 8 章 資料型別
- [x] `the-sql-language/datatype/arrays.md` — 8.15. 陣列 #
...
- [x] `the-sql-language/datatype/datatype-character.md` — 8.3. 字元型別 #
- [ ] `the-sql-language/datatype/datatype-datetime.md` — 8.5. Date/Time Types #
- [x] `the-sql-language/datatype/datatype-enum.md` — 8.7. 列舉型別 #
- [x] `the-sql-language/datatype/datatype-geometric.md` — 8.8. 幾何型別 #
- [x] `the-sql-language/datatype/datatype-json.md` — 8.14. JSON 型別 #
- [x] `the-sql-language/datatype/datatype-money.md` — 8.2. 貨幣型別 #
- [x] `the-sql-language/datatype/datatype-net-types.md` — 8.9. 網路位址型別 #
- [x] `the-sql-language/datatype/datatype-numeric.md` — 8.1. 數值型別 #
- [x] `the-sql-language/datatype/datatype-oid.md` — 8.19. 物件識別碼型別 #
- [x] `the-sql-language/datatype/datatype-pg-lsn.md` — 8.20. pg_lsn Type #
- [x] `the-sql-language/datatype/datatype-pseudo.md` — 8.21. 虛擬型別 #
- [x] `the-sql-language/datatype/datatype-textsearch.md` — 8.11. 全文檢索型別 #
- [x] `the-sql-language/datatype/datatype-uuid.md` — 8.12. UUID 型別 #
...
- [x] `the-sql-language/ddl/README.md` — 第 5 章 資料定義
- [x] `the-sql-language/ddl/ddl-alter.md` — 5.7. 修改資料表 #
- [x] `the-sql-language/ddl/ddl-basics.md` — 5.1. 資料表基礎 #
- [x] `the-sql-language/ddl/ddl-constraints.md` — 5.5. 限制條件 #
- [x] `the-sql-language/ddl/ddl-default.md` — 5.2. 預設值 #
- [x] `the-sql-language/ddl/ddl-depend.md` — 5.15. 相依性追蹤 #
- [x] `the-sql-language/ddl/ddl-foreign-data.md` — 5.13. 外部資料 #
...
- [x] `the-sql-language/ddl/ddl-system-columns.md` — 5.6. 系統欄位 #
...
- [x] `the-sql-language/functions/functions-bitstring.md` — 9.6. 位元字串函式與運算子 #
- [x] `the-sql-language/functions/functions-comparison.md` — 9.2. 比較函式與運算子 #
- [x] `the-sql-language/functions/functions-comparisons.md` — 9.25. 資料列與陣列比較 #
...
- [x] `the-sql-language/functions/functions-json.md` — 9.16. JSON 函式與運算子 #
- [x] `the-sql-language/functions/functions-logical.md` — 9.1. 邏輯運算子 #
- [x] `the-sql-language/functions/functions-matching.md` — 9.7. 模式比對 #
...
- [x] `the-sql-language/functions/functions-sequence.md` — 9.17. 序列操作函式 #
- [x] `the-sql-language/functions/functions-srf.md` — 9.26. 集合回傳函式 #
- [x] `the-sql-language/functions/functions-statistics.md` — 9.31. 統計資訊函式 #
- [x] `the-sql-language/functions/functions-string.md` — 9.4. 字串函式與運算子 #
- [x] `the-sql-language/functions/functions-subquery.md` — 9.24. 子查詢運算式 #
...
- [x] `the-sql-language/functions/functions-xml.md` — 9.15. XML 函式 #
- [x] `the-sql-language/indexes/README.md` — 第 11 章 索引
...
- [x] `the-sql-language/indexes/indexes-opclass.md` — 11.10. 運算子類別與運算子族系 #
- [x] `the-sql-language/indexes/indexes-ordering.md` — 11.4. 索引與 `ORDER BY` #
- [x] `the-sql-language/indexes/indexes-partial.md` — 11.8. 部分索引 #
...
- [x] `the-sql-language/performance-tips/README.md` — 第 14 章 效能提示
- [x] `the-sql-language/performance-tips/explicit-joins.md` — 14.3. 以明確的 `JOIN` 子句控制規劃器 #
...
- [x] `the-sql-language/sql-syntax/sql-syntax-lexical.md` — 4.1. 詞彙結構 #
...
- [x] `the-sql-language/textsearch/textsearch-dictionaries.md` — 12.6. 字典 #
- [x] `the-sql-language/textsearch/textsearch-features.md` — 12.4. 其他功能 #
- [x] `the-sql-language/textsearch/textsearch-indexes.md` — 12.9. 文字搜尋的建議索引型別 #
- [x] `the-sql-language/textsearch/textsearch-intro.md` — 12.1. 簡介 #
- [x] `the-sql-language/textsearch/textsearch-limitations.md` — 12.11. 限制
- [x] `the-sql-language/textsearch/textsearch-parsers.md` — 12.5. 剖析器 #
- [x] `the-sql-language/textsearch/textsearch-psql.md` — 12.10. psql 支援 #
- [x] `the-sql-language/textsearch/textsearch-tables.md` — 12.2. 資料表與索引 #
- [x] `the-sql-language/typeconv/README.md` — 第 10 章 型別轉換
- [x] `the-sql-language/typeconv/typeconv-func.md` — 10.3. 函式 #
- [x] `the-sql-language/typeconv/typeconv-oper.md` — 10.2. 運算子 #
- [x] `the-sql-language/typeconv/typeconv-overview.md` — 10.1. 概觀 #
- [x] `the-sql-language/typeconv/typeconv-query.md` — 10.4. 值的儲存 #
- [x] `the-sql-language/typeconv/typeconv-select.md` — 10.6. `SELECT` 輸出欄位
- [x] `the-sql-language/typeconv/typeconv-union-case.md` — 10.5. `UNION`、`CASE` 與相關結構 #

## tutorial

- [x] `tutorial/README.md` — 第一部分：教學
- [x] `tutorial/tutorial-advanced/README.md` — 第 3 章 進階功能
...
- [x] `tutorial/tutorial-sql/tutorial-agg.md` — 2.7. 彙總函式 #
- [x] `tutorial/tutorial-sql/tutorial-concepts.md` — 2.2. 概念
- [x] `tutorial/tutorial-sql/tutorial-delete.md` — 2.9. 刪除
- [x] `tutorial/tutorial-sql/tutorial-join.md` — 2.6. 資料表之間的聯結（JOIN） #
...
- [x] `tutorial/tutorial-start/tutorial-accessdb.md` — 1.4. 存取資料庫 #
- [x] `tutorial/tutorial-start/tutorial-arch.md` — 1.2. 架構基礎 #
- [x] `tutorial/tutorial-start/tutorial-createdb.md` — 1.3. 建立資料庫 #
- [x] `tutorial/tutorial-start/tutorial-install.md` — 1.1. 安裝 #
