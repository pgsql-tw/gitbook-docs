...
Refer back to the queries in [Section 2.6](../tutorial-sql/tutorial-join.md).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/tutorial-views.html)（英文原文，待翻譯）
