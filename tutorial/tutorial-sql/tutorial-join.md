...
table, and select the pairs of rows where these values match.[<a id="id-1.4.4.7.3.6"></a>[4]](#ftn.id-1.4.4.7.3.6)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/tutorial-join.html)（英文原文，待翻譯）
