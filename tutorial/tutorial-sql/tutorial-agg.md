...
<table border="0" summary="Callout list"><tr><td align="left" valign="top" width="5%"><p><a href="#co.tutorial-agg-like">(1)</a> </p></td><td align="left" valign="top"><p>
      ...
      is explained in <a class="xref" href="../../the-sql-language/functions/functions-matching.md">Section 9.7</a>.
     </p></td></tr></table>
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/tutorial-agg.html)（英文原文，待翻譯）
