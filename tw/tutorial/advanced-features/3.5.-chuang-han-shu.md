...
更多窗函數的細節可以參閱 [4.2.8 節](../../the-sql-language/sql-syntax/value-expressions.md#4-2-8-chuang-han-hu-jiao)、[9.21 節](../../the-sql-language/functions-and-operators/window-functions.md)、[7.2.5 節](../../the-sql-language/queries/7.2.-zi-liao-biao-biao-shi-shi.md#7-2-5-window-function-processing)、及 [SELECT 指令](../../reference/sql-commands/select.md)的說明頁。
