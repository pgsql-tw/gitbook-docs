...
Turning off this parameter does not affect use of WAL archiving for point-in-time recovery \(PITR\) \(see [Section 25.3](https://www.postgresql.org/docs/12/continuous-archiving.html)\).
