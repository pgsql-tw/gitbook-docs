## 58.4. Foreign Data Wrapper Query Planning [#](#FDW-PLANNING)
...
[Section 58.2.4](fdw-callbacks.md#FDW-CALLBACKS-UPDATE) are designed around the assumption
...
[Section 58.2.6](fdw-callbacks.md#FDW-CALLBACKS-ROW-LOCKING). Keep in mind that a path
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/fdw-planning.html)（英文原文，待翻譯）
