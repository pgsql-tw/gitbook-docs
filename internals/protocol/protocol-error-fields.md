## 54.8. Error and Notice Message Fields [#](#PROTOCOL-ERROR-FIELDS)
...
`C`
:   Code: the SQLSTATE code for the error (see [Appendix A](../../appendixes/errcodes-appendix/README.md)). Not localizable. Always present.
...
see [Appendix A](../../appendixes/errcodes-appendix/README.md). Frontends should not assume that
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/protocol-error-fields.html)（英文原文，待翻譯）
