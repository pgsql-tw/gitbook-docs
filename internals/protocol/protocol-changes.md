## 54.10. Summary of Changes since Protocol 2.0 [#](#PROTOCOL-CHANGES)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/protocol-changes.html)（英文原文，待翻譯）
