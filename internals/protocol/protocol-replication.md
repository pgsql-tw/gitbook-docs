## 54.4. Streaming Replication Protocol [#](#PROTOCOL-REPLICATION)
...
[pg_receivewal](../../reference/reference-client/app-pgreceivewal.md) (for physical replication) or
[pg_recvlogical](../../reference/reference-client/app-pgrecvlogical.md) (for logical replication).

Replication commands are logged in the server log when
[log_replication_commands](../../server-administration/runtime-config/runtime-config-logging.md#GUC-LOG-REPLICATION-COMMANDS) is enabled.

The commands accepted in replication mode are:

<a id="PROTOCOL-REPLICATION-IDENTIFY-SYSTEM"></a>

`IDENTIFY_SYSTEM` <a id="id-1.10.6.9.7.1.1.1.2"></a> [#](#PROTOCOL-REPLICATION-IDENTIFY-SYSTEM)
...
<a id="PROTOCOL-REPLICATION-SHOW"></a>

`SHOW` *`name`* <a id="id-1.10.6.9.7.1.2.1.3"></a> [#](#PROTOCOL-REPLICATION-SHOW)
:   Requests the server to send the current setting of a run-time parameter.
    This is similar to the SQL command [SHOW](../../reference/sql-commands/sql-show.md).

    *`name`*
    :   The name of a run-time parameter. Available parameters are documented
        in [Chapter 19](../../server-administration/runtime-config/README.md).
<a id="PROTOCOL-REPLICATION-TIMELINE-HISTORY"></a>

`TIMELINE_HISTORY` *`tli`* <a id="id-1.10.6.9.7.1.3.1.3"></a> [#](#PROTOCOL-REPLICATION-TIMELINE-HISTORY)
...
<a id="PROTOCOL-REPLICATION-CREATE-REPLICATION-SLOT"></a>

`CREATE_REPLICATION_SLOT` *`slot_name`* [ `TEMPORARY` ] { `PHYSICAL` | `LOGICAL` *`output_plugin`* } [ ( *`option`* [, ...] ) ] <a id="id-1.10.6.9.7.1.4.1.8"></a> [#](#PROTOCOL-REPLICATION-CREATE-REPLICATION-SLOT)
:   Create a physical or logical replication
    slot. See [Section 26.2.6](../../server-administration/high-availability/warm-standby.md#STREAMING-REPLICATION-SLOTS) for more about
    replication slots.

    *`slot_name`*
    :   The name of the slot to create. Must be a valid replication slot
        name (see [Section 26.2.6.1](../../server-administration/high-availability/warm-standby.md#STREAMING-REPLICATION-SLOTS-MANIPULATION)).

    *`output_plugin`*
    :   The name of the output plugin used for logical decoding
        (see [Section 47.6](../../server-programming/logicaldecoding/logicaldecoding-output-plugin.md)).
...
<a id="PROTOCOL-REPLICATION-CREATE-REPLICATION-SLOT-LEGACY"></a>
...
<a id="PROTOCOL-REPLICATION-ALTER-REPLICATION-SLOT"></a>

`ALTER_REPLICATION_SLOT` *`slot_name`* ( *`option`* [, ...] ) <a id="id-1.10.6.9.7.1.6.1.4"></a> [#](#PROTOCOL-REPLICATION-ALTER-REPLICATION-SLOT)
:   Change the definition of a replication slot.
    See [Section 26.2.6](../../server-administration/high-availability/warm-standby.md#STREAMING-REPLICATION-SLOTS) for more about
    ...
    *`slot_name`*
    ...
    :   If true, the slot is enabled to be synced to the standbys
        so that logical replication can be resumed after failover.
<a id="PROTOCOL-REPLICATION-READ-REPLICATION-SLOT"></a>

`READ_REPLICATION_SLOT` *`slot_name`* <a id="id-1.10.6.9.7.1.7.1.3"></a> [#](#PROTOCOL-REPLICATION-READ-REPLICATION-SLOT)
...
<a id="PROTOCOL-REPLICATION-START-REPLICATION"></a>

`START_REPLICATION` [ `SLOT` *`slot_name`* ] [ `PHYSICAL` ] *`XXX/XXX`* [ `TIMELINE` *`tli`* ] <a id="id-1.10.6.9.7.1.8.1.8"></a> [#](#PROTOCOL-REPLICATION-START-REPLICATION)
:   Instructs server to start streaming WAL, starting at
    ...
    see [Section 54.6](protocol-message-types.md) and [Section 54.7](protocol-message-formats.md) for details.
    (This allows other information to be intermixed; in particular the server can send
    an ErrorResponse message if it encounters a failure after beginning
    to stream.) The payload of each CopyData message from server to the
    client contains a message of one of the following formats:

    <a id="PROTOCOL-REPLICATION-XLOGDATA"></a>
    ...
    <a id="PROTOCOL-REPLICATION-PRIMARY-KEEPALIVE-MESSAGE"></a>
    ...
    <a id="PROTOCOL-REPLICATION-STANDBY-STATUS-UPDATE"></a>
    ...
    <a id="PROTOCOL-REPLICATION-HOT-STANDBY-FEEDBACK-MESSAGE"></a>
...
<a id="PROTOCOL-REPLICATION-START-REPLICATION-SLOT-LOGICAL"></a>
...
:   Instructs server to start streaming WAL for logical replication,
    ...
    `confirmed_flush_lsn` (see [Section 53.20](../views/view-pg-replication-slots.md)), whichever is greater. This
    ...
    *`option_name`*
    :   The name of an option passed to the slot's logical decoding output
        plugin. See [Section 54.5](protocol-logical-replication.md) for
    ...
    *`option_value`*
    :   Optional value, in the form of a string constant, associated with the
        specified option.
<a id="PROTOCOL-REPLICATION-DROP-REPLICATION-SLOT"></a>

`DROP_REPLICATION_SLOT` *`slot_name`* [ `WAIT` ] <a id="id-1.10.6.9.7.1.10.1.4"></a> [#](#PROTOCOL-REPLICATION-DROP-REPLICATION-SLOT)
:   Drops a replication slot, freeing any reserved server-side resources.
    ...
    *`slot_name`*
    ...
    :   This option causes the command to wait if the slot is active until
        ...
        error.
<a id="PROTOCOL-REPLICATION-UPLOAD-MANIFEST"></a>

`UPLOAD_MANIFEST` <a id="id-1.10.6.9.7.1.11.1.2"></a> [#](#PROTOCOL-REPLICATION-UPLOAD-MANIFEST)
:   Uploads a backup manifest in preparation for taking an incremental
    backup.
<a id="PROTOCOL-REPLICATION-BASE-BACKUP"></a>

`BASE_BACKUP` [ ( *`option`* [, ...] ) ] <a id="id-1.10.6.9.7.1.12.1.3"></a> [#](#PROTOCOL-REPLICATION-BASE-BACKUP)
:   Instructs the server to start streaming a base backup.
    ...
    :   Sets the label of the backup. If none is specified, a backup label
        ...
        [standard_conforming_strings](../../server-administration/runtime-config/runtime-config-compatible.md#GUC-STANDARD-CONFORMING-STRINGS) turned on.
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/protocol-replication.html)（英文原文，待翻譯）
