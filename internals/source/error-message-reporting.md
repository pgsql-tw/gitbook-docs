## 55.2. Reporting Errors Within the Server [#](#ERROR-MESSAGE-REPORTING)

<a id="id-1.10.7.3.2"></a><a id="id-1.10.7.3.3"></a>
...
* `errmsg(const char *msg, ...)` specifies the primary error
  ...
  [<a id="id-1.10.7.3.10.2.2.1.7"></a>[18]](#ftn.id-1.10.7.3.10.2.2.1.7)
...
* `errmsg_plural(const char *fmt_singular, const char *fmt_plural,
  ...
  *`n`* is the integer value that determines which plural
  ...
  [Section 56.2.2](../nls/nls-programmer.md#NLS-GUIDELINES).
...
* `errdetail_plural(const char *fmt_singular, const char *fmt_plural,
  ...
  support for various plural forms of the message.
  For more information see [Section 56.2.2](../nls/nls-programmer.md#NLS-GUIDELINES).
...
[Section 55.3](error-style-guide.md).

<br>

---

<a id="ftn.id-1.10.7.3.10.2.2.1.7"></a>

[[18]](#id-1.10.7.3.10.2.2.1.7) 
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/error-message-reporting.html)（英文原文，待翻譯）
