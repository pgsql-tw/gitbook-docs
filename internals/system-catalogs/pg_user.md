...
The view `pg_user` provides access to information about database users. This is simply a publicly readable view of [`pg_shadow`](../system-views/pg_shadow.md) that blanks out the password field.
