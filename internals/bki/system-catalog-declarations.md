## 68.1. System Catalog Declaration Rules [#](#SYSTEM-CATALOG-DECLARATIONS)
...
OID `#define`s and any other data that might be of use
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/system-catalog-declarations.html)（英文原文，待翻譯）
