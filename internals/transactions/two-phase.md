## 67.4. Two-Phase Transactions [#](#TWO-PHASE)
...
that are currently prepared can be inspected using [`pg_prepared_xacts`](../views/view-pg-prepared-xacts.md).

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/two-phase.html)（英文原文，待翻譯）
