...
The last modification time of the file as reported by the server at the time of the backup. Unlike the other fields stored in the backup, this field is not used by [pg_verifybackup](../../reference/client-applications/pg_verifybackup.md). It is included only for informational purposes.
...
原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/backup-manifest-files.html)（英文原文，待翻譯）
