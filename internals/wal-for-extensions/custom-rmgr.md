## 64.2. Custom WAL Resource Managers [#](#CUSTOM-RMGR)

This section explains the interface between the core
PostgreSQL system and custom WAL resource
managers, which enable extensions to integrate directly with the [WAL](../../server-administration/wal/README.md).

An extension, especially a [Table Access
Method](../tableam/README.md) or [Index Access Method](../indexam/README.md), may
need to use WAL for recovery, replication, and/or [Logical Decoding](../../server-programming/logicaldecoding/README.md).
...
extension module's [_PG_init](../../server-programming/extend/xfunc-c.md#XFUNC-C-DYNLOAD) function.
...
Resource Manager](https://wiki.postgresql.org/wiki/CustomWALResourceManagers) page.

Place the extension module implementing the custom resource manager in [shared_preload_libraries](../../server-administration/runtime-config/runtime-config-client.md#GUC-SHARED-PRELOAD-LIBRARIES) so that it will be loaded early
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/custom-rmgr.html)（英文原文，待翻譯）
