## 60.2. Creating Custom Scan Plans [#](#CUSTOM-SCAN-PLAN)
...
### 60.2.1. Custom Scan Plan Callbacks [#](#CUSTOM-SCAN-PLAN-CALLBACKS)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/custom-scan-plan.html)（英文原文，待翻譯）
