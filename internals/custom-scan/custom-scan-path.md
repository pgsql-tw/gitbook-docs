## 60.1. Creating Custom Scan Paths [#](#CUSTOM-SCAN-PATH)
...
### 60.1.1. Custom Scan Path Callbacks [#](#CUSTOM-SCAN-PATH-CALLBACKS)
...
initialize. See [Section 60.2](custom-scan-plan.md) for more details.
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/custom-scan-path.html)（英文原文，待翻譯）
