## 61.3. Genetic Query Optimization (GEQO) in PostgreSQL [#](#GEQO-PG-INTRO)

[61.3.1. Generating Possible Plans with GEQO](geqo-pg-intro.md#GEQO-PG-INTRO-GEN-POSSIBLE-PLANS)

[61.3.2. Future Implementation Tasks for PostgreSQL GEQO](geqo-pg-intro.md#GEQO-FUTURE)
...
<a id="GEQO-PG-INTRO-GEN-POSSIBLE-PLANS"></a>

### 61.3.1. Generating Possible Plans with GEQO [#](#GEQO-PG-INTRO-GEN-POSSIBLE-PLANS)
...
random number generator with the current [geqo_seed](../../server-administration/runtime-config/runtime-config-query.md#GUC-GEQO-SEED)
...
### 61.3.2. Future Implementation Tasks for PostgreSQL GEQO [#](#GEQO-FUTURE)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/geqo-pg-intro.html)（英文原文，待翻譯）
