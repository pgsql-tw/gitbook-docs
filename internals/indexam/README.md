...
<a id="id-1.10.15.2"></a><a id="id-1.10.15.3"></a>
...
furthermore use the standard page layout described in [Section 66.6](../storage/storage-page-layout.md), and most use the same format for index
...
block number and an item number within that block (see [Section 66.6](../storage/storage-page-layout.md)). This is sufficient
...
tuples](../storage/storage-hot.md) are an exception to this
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/indexam.html)（英文原文，待翻譯）
