## 63.1. Basic API Structure for Indexes [#](#INDEX-API)

Each index access method is described by a row in the
[`pg_am`](../catalogs/catalog-pg-am.md)
...
[CREATE ACCESS METHOD](../../reference/sql-commands/sql-create-access-method.md) and
[DROP ACCESS METHOD](../../reference/sql-commands/sql-drop-access-method.md) SQL commands.
...
in [Section 63.2](index-functions.md).
...
[`pg_opfamily`](../catalogs/catalog-pg-opfamily.md),
[`pg_opclass`](../catalogs/catalog-pg-opclass.md),
[`pg_amop`](../catalogs/catalog-pg-amop.md), and
[`pg_amproc`](../catalogs/catalog-pg-amproc.md).
These entries allow the planner
to determine what kinds of query qualifications can be used with
indexes of this access method. Operator families and classes are described
in [Section 36.16](../../server-programming/extend/xindex.md), which is prerequisite material for reading
this chapter.

An individual index is defined by a
[`pg_class`](../catalogs/catalog-pg-class.md)
entry that describes it as a physical relation, plus a
[`pg_index`](../catalogs/catalog-pg-index.md)
...
are discussed in [Section 63.5](index-unique-checks.md).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/index-api.html)（英文原文，待翻譯）
