...
See `src/backend/storage/freespace/README` for more details on how the FSM is structured, and how it's updated and searched. The [pg\_freespacemap](../../appendixes/additional-supplied-modules/pg_freespacemap.md) module can be used to examine the information stored in free space maps.
