...
This section provides an overview of the page format used within PostgreSQL tables and indexes.[\[15\]](database-page-layout.md#ftn.id-1.10.21.8.2.2) Sequences and TOAST tables are formatted just like a regular table.
...
[Table 68.2](database-page-layout.md#PAGE-TABLE) shows the overall layout of a page. There are five parts to each page.
...
[Figure 68.1](database-page-layout.md#STORAGE-PAGE-LAYOUT-FIGURE) illustrates how these parts are laid out in a page.
