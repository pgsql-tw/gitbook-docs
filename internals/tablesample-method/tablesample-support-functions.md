## 59.1. Sampling Method Support Functions [#](#TABLESAMPLE-SUPPORT-FUNCTIONS)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/tablesample-support-functions.html)（英文原文，待翻譯）
