...
<a id="id-1.10.11.2"></a><a id="id-1.10.11.3"></a>
...
described in [Section 59.1](tablesample-support-functions.md).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/tablesample-method.html)（英文原文，待翻譯）
