## 69.1. Row Estimation Examples [#](#ROW-ESTIMATION-EXAMPLES)

<a id="id-1.10.21.4.2"></a>
...
is covered in [Section 14.2](../../the-sql-language/performance-tips/planner-stats.md), but is repeated here for
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/row-estimation-examples.html)（英文原文，待翻譯）
