## 69.2. Multivariate Statistics Examples [#](#MULTIVARIATE-STATISTICS-EXAMPLES)
...
<a id="id-1.10.21.5.2"></a><a id="FUNCTIONAL-DEPENDENCIES"></a>

### 69.2.1. Functional Dependencies [#](#FUNCTIONAL-DEPENDENCIES)
...
As explained in [Section 14.2](../../the-sql-language/performance-tips/planner-stats.md), the planner can determine
...
<a id="MULTIVARIATE-NDISTINCT-COUNTS"></a>

### 69.2.2. Multivariate N-Distinct Counts [#](#MULTIVARIATE-NDISTINCT-COUNTS)
...
### 69.2.3. MCV Lists [#](#MCV-LISTS)

As explained in [Section 69.2.1](multivariate-statistics-examples.md#FUNCTIONAL-DEPENDENCIES), functional
...
statistics described in [Section 69.1](row-estimation-examples.md). These
...
Let's look at the query from [Section 69.2.1](multivariate-statistics-examples.md#FUNCTIONAL-DEPENDENCIES)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/multivariate-statistics-examples.html)（英文原文，待翻譯）
