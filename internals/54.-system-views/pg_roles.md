...
pg\_roles 這個 view 提供對資料庫角色的資訊。 這只是 [pg\_authid](../system-catalogs/pg_authid.md) 的一個公共可讀的 view，它將密碼部份予以屏蔽。
...
| `oid`            | `oid`         | [`pg_authid`](../system-catalogs/pg_authid.md).oid | 角色的 ID                                                                                    |
