...
See also [`pg_shdepend`](catalog-pg-shdepend.md),
...
<table border="1" class="table" summary="pg_depend Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
...
:   The dependent object is a member of the *extension* that is
    ...
    [`pg_extension`](catalog-pg-extension.md)).
    The dependent object can be dropped only via
    [`DROP EXTENSION`](../../reference/sql-commands/sql-dropextension.md) on the referenced object.
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/catalog-pg-depend.html)（英文原文，待翻譯）
