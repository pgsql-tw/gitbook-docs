...
Operator families are described at length in [Section 36.16](../../server-programming/extend/xindex.md).

<a id="id-1.10.4.37.5"></a>

**Table 52.35. `pg_opfamily` Columns**

<table border="1" class="table" summary="pg_opfamily Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
...
[`pg_amop`](catalog-pg-amop.md),
[`pg_amproc`](catalog-pg-amproc.md),
and
[`pg_opclass`](catalog-pg-opclass.md).

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/catalog-pg-opfamily.html)（英文原文，待翻譯）
