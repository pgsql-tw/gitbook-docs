...
<table border="1" class="table" summary="pg_amop Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
...
referenced [`pg_operator`](catalog-pg-operator.md) entry.
