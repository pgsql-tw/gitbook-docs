...
<table border="1" class="table" summary="pg_enum Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
...
<p>
       The OID of the <a class="link" href="catalog-pg-type.md"><code class="structname">pg_type</code></a> entry owning this enum value
      </p></td></tr><tr><td class="catalog_table_entry"><p class="column_definition">
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/catalog-pg-enum.html)（英文原文，待翻譯）
