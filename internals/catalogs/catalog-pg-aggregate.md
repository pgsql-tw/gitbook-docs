...
<table border="1" class="table" summary="pg_aggregate Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
...
New aggregate functions are registered with the [`CREATE AGGREGATE`](../../reference/sql-commands/sql-createaggregate.md)
command. See [Section 36.12](../../server-programming/extend/xaggr.md) for more information about
