...
See [CREATE OPERATOR](../../reference/sql-commands/sql-createoperator.md)
and [Section 36.14](../../server-programming/extend/xoper.md) for more information.

<a id="id-1.10.4.36.4"></a>

**Table 52.34. `pg_operator` Columns**

<table border="1" class="table" summary="pg_operator Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/catalog-pg-operator.html)（英文原文，待翻譯）
