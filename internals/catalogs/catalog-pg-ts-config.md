...
token-to-dictionary mapping is defined by subsidiary entries in [`pg_ts_config_map`](catalog-pg-ts-config-map.md).
...
<table border="1" class="table" summary="pg_ts_config Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
...
<code class="structfield">cfgparser</code> <code class="type">oid</code>
       (references <a class="link" href="catalog-pg-ts-parser.md"><code class="structname">pg_ts_parser</code></a>.<code class="structfield">oid</code>)
      </p>
<p>
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/catalog-pg-ts-config.html)（英文原文，待翻譯）
