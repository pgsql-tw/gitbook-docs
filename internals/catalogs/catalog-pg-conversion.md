...
encoding conversion functions. See [CREATE CONVERSION](../../reference/sql-commands/sql-createconversion.md)
...
<table border="1" class="table" summary="pg_conversion Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
...
<p>
       Source encoding ID (<a class="link" href="../../the-sql-language/functions/functions-info.md#PG-ENCODING-TO-CHAR"><code class="function">pg_encoding_to_char()</code></a>
       can translate this number to the encoding name)
      </p></td></tr><tr><td class="catalog_table_entry"><p class="column_definition">
<code class="structfield">contoencoding</code> <code class="type">int4</code>
</p>
<p>
       Destination encoding ID (<a class="link" href="../../the-sql-language/functions/functions-info.md#PG-ENCODING-TO-CHAR"><code class="function">pg_encoding_to_char()</code></a>
       can translate this number to the encoding name)
      </p></td></tr><tr><td class="catalog_table_entry"><p class="column_definition">
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/catalog-pg-conversion.html)（英文原文，待翻譯）
