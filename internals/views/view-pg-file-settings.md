...
[`pg_settings`](view-pg-settings.md)
view is usually sufficient to determine that.)

By default, the `pg_file_settings` view can be read
only by superusers.

<a id="id-1.10.5.12.6"></a>

**Table 53.8. `pg_file_settings` Columns**

<table border="1" class="table" summary="pg_file_settings Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
