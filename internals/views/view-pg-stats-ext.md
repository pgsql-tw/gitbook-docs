...
of extended statistics are added to [`pg_statistic_ext`](../catalogs/catalog-pg-statistic-ext.md).

<a id="id-1.10.5.34.5"></a>

**Table 53.30. `pg_stats_ext` Columns**

<table border="1" class="table" summary="pg_stats_ext Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
