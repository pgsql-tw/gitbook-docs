## 56.2. For the Programmer [#](#NLS-PROGRAMMER)

[56.2.1. Mechanics](nls-programmer.md#NLS-MECHANICS)

[56.2.2. Message-Writing Guidelines](nls-programmer.md#NLS-GUIDELINES)

<a id="NLS-MECHANICS"></a>

### 56.2.1. Mechanics [#](#NLS-MECHANICS)
...
1. Insert this code into the start-up sequence of the program:
   ...
   freely.)
2. Wherever a message that is a candidate for translation is found,
   ...
   input strings.
3. Add a file `nls.mk` in the directory with the
...
4. Add a file `po/LINGUAS`, which will contain the list
...
<a id="NLS-GUIDELINES"></a>

### 56.2.2. Message-Writing Guidelines [#](#NLS-GUIDELINES)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/nls-programmer.html)（英文原文，待翻譯）
