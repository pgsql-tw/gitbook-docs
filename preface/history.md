...
[2.1. The Berkeley POSTGRES Project](history.md#HISTORY-BERKELEY)
...
concepts for the system were presented in [[ston86]](../bibliography.md#STON86),
and the definition of the initial data model appeared in [[rowe87]](../bibliography.md#ROWE87). The design of the rule system at that time was
described in [[ston87a]](../bibliography.md#STON87A). The rationale and
architecture of the storage manager were detailed in [[ston87b]](../bibliography.md#STON87B).
...
[[ston90a]](../bibliography.md#STON90A), was released to a few external users in
June 1989. In response to a critique of the first rule system
([[ston89]](../bibliography.md#STON89)), the rule system was redesigned ([[ston90b]](../bibliography.md#STON90B)), and Version 2 was released in June 1990 with
...
[Informix](https://www.ibm.com/analytics/informix),
which is now owned by [IBM](https://www.ibm.com/)) picked up the code and
...
* The query language PostQUEL was replaced with
  ...
  library [libpq](../client-interfaces/libpq/README.md) was named after PostQUEL.)
  Subqueries
...
Postgres is still considered an official
project name, both because of tradition and because people find it
easier to pronounce Postgres than
PostgreSQL.
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/history.html)（英文原文，待翻譯）
