...
Wiki
:   The PostgreSQL [wiki](https://wiki.postgresql.org) contains the project's [FAQ](https://wiki.postgresql.org/wiki/Frequently_Asked_Questions)
    (Frequently Asked Questions) list, [TODO](https://wiki.postgresql.org/wiki/Todo) list, and
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/resources.html)（英文原文，待翻譯）
