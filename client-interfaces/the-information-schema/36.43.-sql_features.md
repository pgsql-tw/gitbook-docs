...
The table `sql_features` contains information about which formal features defined in the SQL standard are supported by PostgreSQL. This is the same information that is presented in [Appendix D](../../appendixes/d.-sql-xiang-rong-xing/README.md). There you can also find some additional background information.
