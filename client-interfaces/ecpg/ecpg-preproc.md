## 34.9. Preprocessor Directives [#](#ECPG-PREPROC)
...
### 34.9.1. Including Files [#](#ECPG-INCLUDE)
...
### 34.9.2. The define and undef Directives [#](#ECPG-DEFINE)
...
### 34.9.3. ifdef, ifndef, elif, else, and endif Directives [#](#ECPG-IFDEF)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/ecpg-preproc.html)（英文原文，待翻譯）
