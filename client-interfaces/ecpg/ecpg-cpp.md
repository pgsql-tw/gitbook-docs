...
the rest of the C++ code. See [Section 34.13.2](ecpg-cpp.md#ECPG-CPP-AND-C)
about that.
...
<a id="ECPG-CPP-AND-C-TEST-MOD-PGC"></a>
...
:   A sub-routine module to execute SQL commands embedded in C.
    ...
    ```
<a id="ECPG-CPP-AND-C-TEST-MOD-H"></a>
...
:   A header file with declarations of the functions in the C
    ...
    #endif
    ```
<a id="ECPG-CPP-AND-C-TEST-CPP-CPP"></a>
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/ecpg-cpp.html)（英文原文，待翻譯）
