...
(See [Section 34.3.2](ecpg-commands.md#ECPG-CURSORS) for more details about the
cursor.)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/ecpg-dynamic.html)（英文原文，待翻譯）
