...
direct SQL statement [PREPARE](../../reference/sql-commands/sql-prepare.md), which can also
be used in embedded programs. The [EXECUTE](../../reference/sql-commands/sql-execute.md)
...
<a id="ECPG-SQL-PREPARE-PREPARED-NAME"></a>

*`prepared_name`* [#](#ECPG-SQL-PREPARE-PREPARED-NAME)
:   An identifier for the prepared query.
<a id="ECPG-SQL-PREPARE-STRING"></a>
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/ecpg-sql-prepare.html)（英文原文，待翻譯）
