...
<a id="ECPG-DEVELOP-ECPGT-EORT"></a>
...
10. The offset to the next element in the indicator array (for
    array fetches).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/ecpg-develop.html)（英文原文，待翻譯）
