...
can be retrieved with [`PQerrorMessage`](../libpq/libpq-status.md#LIBPQ-PQERRORMESSAGE).
...
[lo_compat_privileges](../../server-administration/runtime-config/runtime-config-compatible.md#GUC-LO-COMPAT-PRIVILEGES) run-time parameter.
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/lo-interfaces.html)（英文原文，待翻譯）
