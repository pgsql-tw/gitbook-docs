...
<code class="literal">GOTO <em class="replaceable"><code>label</code></em></code><br><code class="literal">GO TO <em class="replaceable"><code>label</code></em></code>
...
<code class="literal">CALL <em class="replaceable"><code>name</code></em> (<em class="replaceable"><code>args</code></em>)</code><br><code class="literal">DO <em class="replaceable"><code>name</code></em> (<em class="replaceable"><code>args</code></em>)</code>
...
原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/ecpg-errors.html)（英文原文，待翻譯）
