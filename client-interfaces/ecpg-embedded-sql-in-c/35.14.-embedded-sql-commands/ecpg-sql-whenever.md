...
See [Section 36.8.1](../35.8.-error-handling.md#ECPG-WHENEVER) for a description of the parameters.
...
原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/ecpg-sql-whenever.html)（英文原文，待翻譯）
