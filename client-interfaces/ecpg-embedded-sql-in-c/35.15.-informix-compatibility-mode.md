...
Reserved in Informix, value of [`PQfformat`](../libpq-c-library/connection-status-functions-2.md#LIBPQ-PQFFORMAT) for the field.
...
Extended type of the field, result of [`PQftype`](../libpq-c-library/connection-status-functions-2.md#LIBPQ-PQFTYPE).
...
原文：[PostgreSQL 15.19 Documentation](35.15.-informix-compatibility-mode.md)（英文原文，待翻譯）
