...
If a query is expected to return more than one result row, a cursor should be used, as in the following example. (See [Section 36.3.2](35.3.-running-sql-commands.md#ECPG-CURSORS) for more details about the cursor.)
...
原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/ecpg-dynamic.html)（英文原文，待翻譯）
