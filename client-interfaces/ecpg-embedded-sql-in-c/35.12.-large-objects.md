...
For more details about the `ECPGget_PGconn()`, see [Section 36.11](35.11.-library-functions.md). For information about the large object function interface, see [Chapter 35](../34.-large-objects/README.md).
...
[Example 36.2](#ECPG-LO-EXAMPLE) shows an example program that illustrates how to create, write, and read a large object in an ECPG application.

<a id="ECPG-LO-EXAMPLE"></a>

<strong>Example 36.2. ECPG Program Accessing Large Objects</strong>
...
原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/ecpg-lo.html)（英文原文，待翻譯）
