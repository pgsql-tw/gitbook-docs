...
You can use `pg_config`<a id="id-1.7.5.16.6.2"></a> or `pkg-config`<a id="id-1.7.5.16.6.4"></a> with package name `libecpg` to get the paths for your installation.
...
The complete syntax of the `ecpg` command is detailed in [ecpg](../../reference/client-applications/ecpg.md).
...
原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/ecpg-process.html)（英文原文，待翻譯）
