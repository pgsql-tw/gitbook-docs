...
The deprecated functions [`PQrequestCancel`](33.6.-canceling-queries-in-progress.md#LIBPQ-PQREQUESTCANCEL) and [`PQoidStatus`](https://www.postgresql.org/docs/15/libpq-exec.html#LIBPQ-PQOIDSTATUS) are not thread-safe and should not be used in multithread programs. [`PQrequestCancel`](33.6.-canceling-queries-in-progress.md#LIBPQ-PQREQUESTCANCEL) can be replaced by [`PQcancel`](33.6.-canceling-queries-in-progress.md#LIBPQ-PQCANCEL). [`PQoidStatus`](https://www.postgresql.org/docs/15/libpq-exec.html#LIBPQ-PQOIDSTATUS) can be replaced by [`PQoidValue`](https://www.postgresql.org/docs/15/libpq-exec.html#LIBPQ-PQOIDVALUE).
...
原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/libpq-threading.html)（英文原文，待翻譯）
