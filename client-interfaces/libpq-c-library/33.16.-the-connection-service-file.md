...
Either service file uses an “INI file” format where the section name is the service name and the parameters are connection parameters; see [Section 34.1.2](database-connection-control-functions.md#LIBPQ-PARAMKEYWORDS) for a list. For example:
...
原文：[PostgreSQL 15.19 Documentation](33.16.-the-connection-service-file.md)（英文原文，待翻譯）
