...
Either service file uses an “INI file” format where the section name is the service name and the parameters are connection parameters; see [Section 34.1.2](https://www.postgresql.org/docs/15/libpq-connect.html#LIBPQ-PARAMKEYWORDS) for a list. For example:
...
原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/libpq-pgservice.html)（英文原文，待翻譯）
