...
<a id="id-1.7.6.44.3"></a>

**Table 35.38. `routine_column_usage` Columns**

<table border="1" class="table" summary="routine_column_usage Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/infoschema-routine-column-usage.html)（英文原文，待翻譯）
