...
see [Section 35.23](infoschema-domains.md) instead.

<a id="id-1.7.6.64.4"></a>

**Table 35.58. `user_defined_types` Columns**

<table border="1" class="table" summary="user_defined_types Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
