...
<table border="1" class="table" summary="role_routine_grants Columns"><colgroup><col/></colgroup><thead><tr><th class="catalog_table_entry"><p class="column_definition">
       Column Type
      </p>
<p>
       Description
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/infoschema-role-routine-grants.html)（英文原文，待翻譯）
