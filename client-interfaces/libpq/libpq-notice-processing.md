...
The function <a id="LIBPQ-PQSETNOTICERECEIVER"></a>`PQsetNoticeReceiver`
<a id="id-1.7.3.20.5.2"></a>
<a id="id-1.7.3.20.5.3"></a> sets or
examines the current notice receiver for a connection object.
Similarly, <a id="LIBPQ-PQSETNOTICEPROCESSOR"></a>`PQsetNoticeProcessor`
<a id="id-1.7.3.20.5.5"></a>
<a id="id-1.7.3.20.5.6"></a> sets or
...
individual fields using [`PQresultErrorField`](libpq-exec.md#LIBPQ-PQRESULTERRORFIELD), or obtain a
complete preformatted message using [`PQresultErrorMessage`](libpq-exec.md#LIBPQ-PQRESULTERRORMESSAGE)
or [`PQresultVerboseErrorMessage`](libpq-exec.md#LIBPQ-PQRESULTVERBOSEERRORMESSAGE).) The same
void pointer passed to `PQsetNoticeReceiver` is also
passed. (This pointer can be used to access application-specific state
if needed.)

The default notice receiver simply extracts the message (using
[`PQresultErrorMessage`](libpq-exec.md#LIBPQ-PQRESULTERRORMESSAGE)) and passes it to the notice
processor.
...
[`PQgetvalue`](libpq-exec.md#LIBPQ-PQGETVALUE).

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/libpq-notice-processing.html)（英文原文，待翻譯）
