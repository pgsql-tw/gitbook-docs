## 32.22. Building libpq Programs [#](#LIBPQ-BUILD)

<a id="id-1.7.3.29.2"></a>
...
* Point your compiler to the directory where the PostgreSQL header
  ...
  `pg_config`<a id="id-1.7.3.29.3.2.2.2.2"></a> to find out where the header
  ...
  If you
  have `pkg-config`<a id="id-1.7.3.29.3.2.2.3.2"></a> installed, you can run instead:
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/libpq-build.html)（英文原文，待翻譯）
