...
A Tcl list of the arguments to the function as given in the `CREATE TRIGGER` statement. These arguments are also accessible as `$1` ... <code class="literal">$<em class="replaceable"><code>n</code></em></code> in the function body.
