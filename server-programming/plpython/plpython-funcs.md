## 44.1. PL/Python Functions [#](#PLPYTHON-FUNCS)

Functions in PL/Python are declared via the
standard [CREATE FUNCTION](../../reference/sql-commands/sql-createfunction.md) syntax:
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/plpython-funcs.html)（英文原文，待翻譯）
