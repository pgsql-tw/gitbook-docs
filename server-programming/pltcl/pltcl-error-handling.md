## 42.8. Error Handling in PL/Tcl [#](#PLTCL-ERROR-HANDLING)
...
in [Appendix A](../../appendixes/errcodes-appendix/README.md)).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/pltcl-error-handling.html)（英文原文，待翻譯）
