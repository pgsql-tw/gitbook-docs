...
the standard [CREATE FUNCTION](../../reference/sql-commands/sql-createfunction.md) syntax:
...
a `return` statement. In a procedure, the return value
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/pltcl-functions.html)（英文原文，待翻譯）
