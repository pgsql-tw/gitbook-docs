## 42.9. Explicit Subtransactions in PL/Tcl [#](#PLTCL-SUBTRANSACTIONS)

<a id="id-1.8.9.13.2"></a>

Recovering from errors caused by database access as described in
[Section 42.8](pltcl-error-handling.md) can lead to an undesirable
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/pltcl-subtransactions.html)（英文原文，待翻譯）
