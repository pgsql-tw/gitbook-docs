## 49.1. Initialization Functions [#](#ARCHIVE-MODULE-INIT)

<a id="id-1.8.16.7.2"></a>

An archive library is loaded by dynamically loading a shared library with the
[archive_library](../../server-administration/runtime-config/runtime-config-wal.md#GUC-ARCHIVE-LIBRARY)'s name as the library base name. The
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/archive-module-init.html)（英文原文，待翻譯）
