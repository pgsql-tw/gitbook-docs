...
Specifies the error code (SQLSTATE) to report, either by condition name, as shown in [Appendix A](../../appendixes/postgresql-error-codes.md), or directly as a five-character SQLSTATE code.
