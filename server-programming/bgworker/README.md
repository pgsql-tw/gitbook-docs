...
If `BGWORKER_BYPASS_ROLELOGINCHECK` is specified as
`flags` it is possible to bypass the login check for the
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/bgworker.html)（英文原文，待翻譯）
