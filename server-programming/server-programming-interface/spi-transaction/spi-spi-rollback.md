<a id="SPI-SPI-ROLLBACK"></a><a id="id-1.8.12.11.5.1"></a><a id="id-1.8.12.11.5.2"></a>
...
原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/spi-spi-rollback.html)（英文原文，待翻譯）
