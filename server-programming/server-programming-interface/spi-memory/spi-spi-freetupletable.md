<a id="SPI-SPI-FREETUPLETABLE"></a><a id="id-1.8.12.10.13.1"></a>
...
<code class="literal">SPITupleTable &#42; <em class="parameter"><code>tuptable</code></em></code>

pointer to row set to free, or NULL to do nothing

---

原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/spi-spi-freetupletable.html)（英文原文，待翻譯）
