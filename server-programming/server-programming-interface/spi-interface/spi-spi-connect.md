<a id="SPI-SPI-CONNECT"></a><a id="id-1.8.12.8.2.1"></a><a id="id-1.8.12.8.2.2"></a>
...
Sets the SPI connection to be <em class="firstterm">nonatomic</em>, which means that transaction control calls (`SPI_commit`, `SPI_rollback`) are allowed. Otherwise, calling those functions will result in an immediate error.
