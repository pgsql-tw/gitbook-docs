<a id="SPI-SPI-REGISTER-RELATION"></a><a id="id-1.8.12.8.31.1"></a><a id="id-1.8.12.8.31.2"></a>
...
<code class="literal">EphemeralNamedRelation <em class="parameter"><code>enr</code></em></code>
...
if <em class="parameter"><code>enr</code></em> is `NULL` or its `name` field is `NULL`
...
if the name specified in the `name` field of <em class="parameter"><code>enr</code></em> is already registered for this connection
