## 41.1. Overview [#](#PLPGSQL-OVERVIEW)
...
### 41.1.1. Advantages of Using PL/pgSQL [#](#PLPGSQL-ADVANTAGES)
...
### 41.1.2. Supported Argument and Result Data Types [#](#PLPGSQL-ARGS-RESULTS)
...
calling query, as discussed in [Section 7.2.1.4](../../the-sql-language/queries/queries-table-expressions.md#QUERIES-TABLEFUNCTIONS).
...
[Section 36.5.6](../extend/xfunc-sql.md#XFUNC-SQL-VARIADIC-FUNCTIONS).

PL/pgSQL functions can also be declared to
accept and return the polymorphic types described in
[Section 36.2.5](../extend/extend-type-system.md#EXTEND-TYPES-POLYMORPHIC), thus allowing the actual data
types handled by the function to vary from call to call.
Examples appear in [Section 41.3.1](plpgsql-declarations.md#PLPGSQL-DECLARATION-PARAMETERS).
...
[Section 41.3.1](plpgsql-declarations.md#PLPGSQL-DECLARATION-PARAMETERS) and
[Section 41.6.1](plpgsql-control-structures.md#PLPGSQL-STATEMENTS-RETURNING).

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/plpgsql-overview.html)（英文原文，待翻譯）
