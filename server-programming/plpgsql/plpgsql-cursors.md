...
command [`DECLARE
CURSOR`](../../reference/sql-commands/sql-declare.md).)
PL/pgSQL has
...
[Section 41.7.3.5](plpgsql-cursors.md#PLPGSQL-CURSOR-RETURNING).
...
from one run to the next (see [Section 41.11.2](plpgsql-implementation.md#PLPGSQL-PLAN-CACHING)),
...
functions, described in [Section 4.3](../../the-sql-language/sql-syntax/sql-syntax-calling-funcs.md), it
...
variants allowed in the SQL [FETCH](../../reference/sql-commands/sql-fetch.md)
...
the same way as during an `OPEN` (see [Section 41.7.2.3](plpgsql-cursors.md#PLPGSQL-OPEN-BOUND-CURSOR)).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/plpgsql-cursors.html)（英文原文，待翻譯）
