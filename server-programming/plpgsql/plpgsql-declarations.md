## 41.3. Declarations [#](#PLPGSQL-DECLARATIONS)
...
variable (see [Section 41.3.6](plpgsql-declarations.md#PLPGSQL-DECLARATION-COLLATION)).
If `NOT NULL`
...
### 41.3.1. Declaring Function Parameters [#](#PLPGSQL-DECLARATION-PARAMETERS)
...
As discussed in [Section 36.5.4](../extend/xfunc-sql.md#XFUNC-OUTPUT-PARAMETERS), this
...
of the call. See [Section 41.6.3](plpgsql-control-structures.md#PLPGSQL-STATEMENTS-CALLING-PROCEDURE)
for details.
...
[Section 36.2.5](../extend/extend-type-system.md#EXTEND-TYPES-POLYMORPHIC)), a special
...
as shown in [Section 41.3.3](plpgsql-declarations.md#PLPGSQL-DECLARATION-TYPE).
...
### 41.3.3. Copying Types [#](#PLPGSQL-DECLARATION-TYPE)
...
`%TYPE` provides the data type of a table column
or a previously-declared PL/pgSQL
...
(See [Section 8.15.1](../../the-sql-language/datatype/arrays.md#ARRAYS-DECLARATION).)
...
### 41.3.4. Row Types [#](#PLPGSQL-DECLARATION-ROWTYPES)
...
### 41.3.5. Record Types [#](#PLPGSQL-DECLARATION-RECORDS)
...
### 41.3.6. Collation of PL/pgSQL Variables [#](#PLPGSQL-DECLARATION-COLLATION)
...
arguments, as described in [Section 23.2](../../server-administration/charset/collation.md). If a collation is
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/plpgsql-declarations.html)（英文原文，待翻譯）
