## 36.16. Interfacing Extensions to Indexes [#](#XINDEX)
...
as [B-Tree](../../internals/indextypes/btree.md)
or [GIN](../../internals/indextypes/gin.md). Custom index access method may be
defined with [CREATE ACCESS METHOD](../../reference/sql-commands/sql-create-access-method.md). See
[Chapter 63](../../internals/indexam/README.md) for details.

The routines for an index method do not directly know anything
about the data types that the index method will operate on.
Instead, an *operator
class*<a id="id-1.8.3.19.5.3.2"></a>
...
The B-tree index method defines five strategies, shown in [Table 36.3](xindex.md#XINDEX-BTREE-STRAT-TABLE).

<a id="XINDEX-BTREE-STRAT-TABLE"></a>

**Table 36.3. B-Tree Strategies**

<table border="1" class="table" summary="B-Tree Strategies"><colgroup><col/><col/></colgroup><thead><tr><th>Operation</th><th>Strategy Number</th></tr></thead><tbody><tr><td>less than</td><td>1</td></tr><tr><td>less than or equal</td><td>2</td></tr><tr><td>equal</td><td>3</td></tr><tr><td>greater than or equal</td><td>4</td></tr><tr><td>greater than</td><td>5</td></tr></tbody></table>

<br>

Hash indexes support only equality comparisons, and so they use only one
strategy, shown in [Table 36.4](xindex.md#XINDEX-HASH-STRAT-TABLE).

<a id="XINDEX-HASH-STRAT-TABLE"></a>

**Table 36.4. Hash Strategies**

<table border="1" class="table" summary="Hash Strategies"><colgroup><col/><col/></colgroup><thead><tr><th>Operation</th><th>Strategy Number</th></tr></thead><tbody><tr><td>equal</td><td>1</td></tr></tbody></table>
...
operator classes for points are shown in [Table 36.6](xindex.md#XINDEX-SPGIST-POINT-STRAT-TABLE).

<a id="XINDEX-SPGIST-POINT-STRAT-TABLE"></a>

**Table 36.6. SP-GiST Point Strategies**

<table border="1" class="table" summary="SP-GiST Point Strategies"><colgroup><col/><col/></colgroup><thead><tr><th>Operation</th><th>Strategy Number</th></tr></thead><tbody><tr><td>strictly left of</td><td>1</td></tr><tr><td>strictly right of</td><td>5</td></tr><tr><td>same</td><td>6</td></tr><tr><td>contained by</td><td>8</td></tr><tr><td>strictly below</td><td>10</td></tr><tr><td>strictly above</td><td>11</td></tr></tbody></table>
...
[Table 36.7](xindex.md#XINDEX-GIN-ARRAY-STRAT-TABLE).

<a id="XINDEX-GIN-ARRAY-STRAT-TABLE"></a>

**Table 36.7. GIN Array Strategies**

<table border="1" class="table" summary="GIN Array Strategies"><colgroup><col/><col/></colgroup><thead><tr><th>Operation</th><th>Strategy Number</th></tr></thead><tbody><tr><td>overlap</td><td>1</td></tr><tr><td>contains</td><td>2</td></tr><tr><td>is contained by</td><td>3</td></tr><tr><td>equal</td><td>4</td></tr></tbody></table>
...
[Table 36.8](xindex.md#XINDEX-BRIN-MINMAX-STRAT-TABLE).

<a id="XINDEX-BRIN-MINMAX-STRAT-TABLE"></a>

**Table 36.8. BRIN Minmax Strategies**

<table border="1" class="table" summary="BRIN Minmax Strategies"><colgroup><col/><col/></colgroup><thead><tr><th>Operation</th><th>Strategy Number</th></tr></thead><tbody><tr><td>less than</td><td>1</td></tr><tr><td>less than or equal</td><td>2</td></tr><tr><td>equal</td><td>3</td></tr><tr><td>greater than or equal</td><td>4</td></tr><tr><td>greater than</td><td>5</td></tr></tbody></table>
...
in [Section 36.16.7](xindex.md#XINDEX-ORDERING-OPS).)

<a id="XINDEX-SUPPORT"></a>
...
supplied at the operator class author's option, as shown in [Table 36.9](xindex.md#XINDEX-BTREE-SUPPORT-TABLE).
The requirements for these support functions are explained further in
[Section 65.1.3](../../internals/indextypes/btree.md#BTREE-SUPPORT-FUNCS).

<a id="XINDEX-BTREE-SUPPORT-TABLE"></a>

**Table 36.9. B-Tree Support Functions**

<table border="1" class="table" summary="B-Tree Support Functions"><colgroup><col class="col1"/><col class="col2"/></colgroup><thead><tr><th>Function</th><th>Support Number</th></tr></thead><tbody><tr><td>
...
be supplied at the operator class author's option, as shown in [Table 36.10](xindex.md#XINDEX-HASH-SUPPORT-TABLE).

<a id="XINDEX-HASH-SUPPORT-TABLE"></a>

**Table 36.10. Hash Support Functions**

<table border="1" class="table" summary="Hash Support Functions"><colgroup><col class="col1"/><col class="col2"/></colgroup><thead><tr><th>Function</th><th>Support Number</th></tr></thead><tbody><tr><td>Compute the 32-bit hash value for a key</td><td>1</td></tr><tr><td>
...
as shown in [Table 36.11](xindex.md#XINDEX-GIST-SUPPORT-TABLE).
(For more information see [Section 65.2](../../internals/indextypes/gist.md).)

<a id="XINDEX-GIST-SUPPORT-TABLE"></a>

**Table 36.11. GiST Support Functions**

<table border="1" class="table" summary="GiST Support Functions"><colgroup><col class="col1"/><col class="col2"/><col class="col3"/></colgroup><thead><tr><th>Function</th><th>Description</th><th>Support Number</th></tr></thead><tbody><tr><td><code class="function">consistent</code></td><td>determine whether key satisfies the
...
<table border="1" class="table" summary="SP-GiST Support Functions"><colgroup><col class="col1"/><col class="col2"/><col class="col3"/></colgroup><thead><tr><th>Function</th><th>Description</th><th>Support Number</th></tr></thead><tbody><tr><td><code class="function">config</code></td><td>provide basic information about the operator class</td><td>1</td></tr><tr><td><code class="function">choose</code></td><td>determine how to insert a new value into an inner tuple</td><td>2</td></tr><tr><td><code class="function">picksplit</code></td><td>determine how to partition a set of values</td><td>3</td></tr><tr><td><code class="function">inner_consistent</code></td><td>determine which sub-partitions need to be searched for a
        ...
        (optional)</td><td>6</td></tr></tbody></table>

<br>

GIN indexes have seven support functions, four of which are optional,
as shown in [Table 36.13](xindex.md#XINDEX-GIN-SUPPORT-TABLE).
(For more information see [Section 65.4](../../internals/indextypes/gin.md).)

<a id="XINDEX-GIN-SUPPORT-TABLE"></a>

**Table 36.13. GIN Support Functions**

<table border="1" class="table" summary="GIN Support Functions"><colgroup><col class="col1"/><col class="col2"/><col class="col3"/></colgroup><thead><tr><th>Function</th><th>Description</th><th>Support Number</th></tr></thead><tbody><tr><td><code class="function">compare</code></td><td>
...
as shown in [Table 36.14](xindex.md#XINDEX-BRIN-SUPPORT-TABLE). Some versions of
the basic functions require additional support functions to be provided.
(For more information see [Section 65.5.3](../../internals/indextypes/brin.md#BRIN-EXTENSIBILITY).)

<a id="XINDEX-BRIN-SUPPORT-TABLE"></a>

**Table 36.14. BRIN Support Functions**

<table border="1" class="table" summary="BRIN Support Functions"><colgroup><col class="col1"/><col class="col2"/><col class="col3"/></colgroup><thead><tr><th>Function</th><th>Description</th><th>Support Number</th></tr></thead><tbody><tr><td><code class="function">opcInfo</code></td><td>
...
discussed in [Section 36.14](xoper.md). For an operator class on
...
family*<a id="id-1.8.3.19.9.3.3"></a>.
...
compatibly, as is specified in detail in [Section 65.1.2](../../internals/indextypes/btree.md#BTREE-BEHAVIOR).
For each
...
for window functions (see [Section 4.2.8](../../the-sql-language/sql-syntax/sql-expressions.md#SYNTAX-WINDOW-FUNCTIONS)).
For a query such as
...
<a id="XINDEX-OPCLASS-FEATURES"></a>
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/xindex.html)（英文原文，待翻譯）
