## 36.13. User-Defined Types [#](#XTYPES)

[36.13.1. TOAST Considerations](xtypes.md#XTYPES-TOAST)

<a id="id-1.8.3.16.2"></a>

As described in [Section 36.2](extend-type-system.md),
...
[CREATE TYPE](../../reference/sql-commands/sql-createtype.md) command.
...
usually desirable to make the data type TOAST-able (see [Section 66.2](../../internals/storage/storage-toast.md)). You should do this even if the values are always
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/xtypes.html)（英文原文，待翻譯）
