## 36.2. The PostgreSQL Type System [#](#EXTEND-TYPE-SYSTEM)
...
them.
The built-in base types are described in [Chapter 8](../../the-sql-language/datatype/README.md).
...
Refer to [Section 8.7](../../the-sql-language/datatype/datatype-enum.md) for more information.
...
one-dimensional arrays. Refer to [Section 8.15](../../the-sql-language/datatype/arrays.md) for more
information.

Composite types, or row types, are created whenever the user
creates a table. It is also possible to use [CREATE TYPE](../../reference/sql-commands/sql-createtype.md) to
define a “stand-alone” composite type with no associated
table. A composite type is simply a list of types with
associated field names. A value of a composite type is a row or
record of field values. Refer to [Section 8.16](../../the-sql-language/datatype/rowtypes.md)
...
a few built-in ones exist. Refer to [Section 8.17](../../the-sql-language/datatype/rangetypes.md)
for more information.
...
the SQL command [CREATE DOMAIN](../../reference/sql-commands/sql-createdomain.md).
Refer to [Section 8.18](../../the-sql-language/datatype/domains.md) for more information.
...
type system to identify special classes of functions. [Table 8.27](../../the-sql-language/datatype/datatype-pseudo.md#DATATYPE-PSEUDOTYPES-TABLE) lists the existing
pseudo-types.
...
[Table 36.1](extend-type-system.md#EXTEND-TYPES-POLYMORPHIC-TABLE). Some examples of
their use appear in [Section 36.5.11](xfunc-sql.md#XFUNC-SQL-POLYMORPHIC-FUNCTIONS).
...
<table border="1" class="table" summary="Polymorphic Types"><colgroup><col class="col1"/><col class="col2"/><col class="col3"/></colgroup><thead><tr><th>Name</th><th>Family</th><th>Description</th></tr></thead><tbody><tr><td><code class="type">anyelement</code></td><td>Simple</td><td>Indicates that a function accepts any data type</td></tr><tr><td><code class="type">anyarray</code></td><td>Simple</td><td>Indicates that a function accepts any array data type</td></tr><tr><td><code class="type">anynonarray</code></td><td>Simple</td><td>Indicates that a function accepts any non-array data type</td></tr><tr><td><code class="type">anyenum</code></td><td>Simple</td><td>Indicates that a function accepts any enum data type
        (see <a class="xref" href="../../the-sql-language/datatype/datatype-enum.md">Section 8.7</a>)
        </td></tr><tr><td><code class="type">anyrange</code></td><td>Simple</td><td>Indicates that a function accepts any range data type
        (see <a class="xref" href="../../the-sql-language/datatype/rangetypes.md">Section 8.17</a>)
...
related constructs (see [Section 10.5](../../the-sql-language/typeconv/typeconv-union-case.md)).
...
[Section 36.5.6](xfunc-sql.md#XFUNC-SQL-VARIADIC-FUNCTIONS)) can be
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/extend-type-system.html)（英文原文，待翻譯）
