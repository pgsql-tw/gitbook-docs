## 36.5. Query Language (SQL) Functions [#](#XFUNC-SQL)
...
the function (see [Section 4.1.2.1](../../the-sql-language/sql-syntax/sql-syntax-lexical.md#SQL-SYNTAX-STRINGS)).

<a id="XFUNC-SQL-FUNCTION-ARGUMENTS"></a>

### 36.5.1. Arguments for SQL Functions [#](#XFUNC-SQL-FUNCTION-ARGUMENTS)
...
### 36.5.2. SQL Functions on Base Types [#](#XFUNC-SQL-BASE-FUNCTIONS)
...
to `float8`.
(See [Chapter 10](../../the-sql-language/typeconv/README.md) or [CREATE CAST](../../reference/sql-commands/sql-createcast.md)
for more about casts.)

<a id="XFUNC-SQL-COMPOSITE-FUNCTIONS"></a>

### 36.5.3. SQL Functions on Composite Types [#](#XFUNC-SQL-COMPOSITE-FUNCTIONS)
...
(See [Section 8.16.5](../../the-sql-language/datatype/rowtypes.md#ROWTYPES-USAGE) for details about these
...
The second way is described more fully in [Section 36.5.8](xfunc-sql.md#XFUNC-SQL-TABLE-FUNCTIONS).
...
As explained in [Section 8.16.5](../../the-sql-language/datatype/rowtypes.md#ROWTYPES-USAGE), the field notation and
...
### 36.5.4. SQL Functions with Output Parameters [#](#XFUNC-OUTPUT-PARAMETERS)
...
shown in [Section 36.5.2](xfunc-sql.md#XFUNC-SQL-BASE-FUNCTIONS). The real value of
...
### 36.5.5. SQL Procedures with Output Parameters [#](#XFUNC-OUTPUT-PARAMETERS-PROC)
...
that will receive the procedure's output. See [Section 41.6.3](../plpgsql/plpgsql-control-structures.md#PLPGSQL-STATEMENTS-CALLING-PROCEDURE) for details.

<a id="XFUNC-SQL-VARIADIC-FUNCTIONS"></a>

### 36.5.6. SQL Functions with Variable Numbers of Arguments [#](#XFUNC-SQL-VARIADIC-FUNCTIONS)
...
[Section 10.3](../../the-sql-language/typeconv/typeconv-func.md). You can do this by
...
possible to call a variadic function using named arguments ([Section 4.3](../../the-sql-language/sql-syntax/sql-syntax-calling-funcs.md)), except when you specify
...
### 36.5.7. SQL Functions with Default Values for Arguments [#](#XFUNC-SQL-PARAMETER-DEFAULTS)
...
[Section 10.3](../../the-sql-language/typeconv/typeconv-func.md).
...
### 36.5.8. SQL Functions as Table Sources [#](#XFUNC-SQL-TABLE-FUNCTIONS)
...
### 36.5.9. SQL Functions Returning Sets [#](#XFUNC-SQL-FUNCTIONS-RETURNING-SET)
...
which is described in [Section 7.2.1.5](../../the-sql-language/queries/queries-table-expressions.md#QUERIES-LATERAL).
...
`UPDATE`, `DELETE`, or
`MERGE` with `RETURNING`, that command will
...
### 36.5.10. SQL Functions Returning `TABLE` [#](#XFUNC-SQL-FUNCTIONS-RETURNING-TABLE)
...
### 36.5.11. Polymorphic SQL Functions [#](#XFUNC-SQL-POLYMORPHIC-FUNCTIONS)

SQL functions can be declared to accept and
return the polymorphic types described in [Section 36.2.5](extend-type-system.md#EXTEND-TYPES-POLYMORPHIC). Here is a polymorphic
...
### 36.5.12. SQL Functions with Collations [#](#XFUNC-SQL-COLLATIONS)
...
collations assigned to the actual arguments, as described in [Section 23.2](../../server-administration/charset/collation.md). If a collation is successfully identified
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/xfunc-sql.html)（英文原文，待翻譯）
