...
`plperl.on_init` (`string`) <a id="id-1.8.10.16.2.3.1.1.3"></a>
...
`plperl.on_plperl_init` (`string`) <a id="id-1.8.10.16.2.3.2.1.3"></a><br> `plperl.on_plperlu_init` (`string`) <a id="id-1.8.10.16.2.3.2.2.3"></a>
...
`plperl.use_strict` (`boolean`) <a id="id-1.8.10.16.2.3.3.1.3"></a>
