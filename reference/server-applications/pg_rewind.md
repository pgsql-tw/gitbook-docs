<a id="APP-PGREWIND"></a><a id="id-1.9.5.9.1"></a>
...
<a id="id-1.9.5.9.4.1"></a>

`pg_rewind` [<em class="replaceable"><code>option</code></em>...] { `-D` | `--target-pgdata` } <em class="replaceable"><code>directory</code></em> { <code class="option">--source-pgdata=<em class="replaceable"><code>directory</code></em></code> | <code class="option">--source-server=<em class="replaceable"><code>connstr</code></em></code> }
...
<code class="option">-D <em class="replaceable"><code>directory</code></em></code><br><code class="option">--target-pgdata=<em class="replaceable"><code>directory</code></em></code>
...
<code class="option">--source-pgdata=<em class="replaceable"><code>directory</code></em></code>
...
<code class="option">--source-server=<em class="replaceable"><code>connstr</code></em></code>
...
When `--source-server` option is used, pg_rewind also uses the environment variables supported by libpq (see [Section 34.15](../../client-interfaces/libpq-c-library/environment-variables.md)).
...
原文：[PostgreSQL 15.19 Documentation](pg_rewind.md)（英文原文，待翻譯）
