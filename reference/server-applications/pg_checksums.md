<a id="APP-PGCHECKSUMS"></a><a id="id-1.9.5.5.1"></a>
...
<a id="id-1.9.5.5.4.1"></a>

`pg_checksums` [<em class="replaceable"><code>option</code></em>...] [[ `-D` | `--pgdata` ]<em class="replaceable"><code>datadir</code></em>]

<a id="R1-APP-PG_CHECKSUMS-1"></a>
...
<code class="option">-D <em class="replaceable"><code>directory</code></em></code><br><code class="option">--pgdata=<em class="replaceable"><code>directory</code></em></code>
...
<code class="option">-f <em class="replaceable"><code>filenode</code></em></code><br><code class="option">--filenode=<em class="replaceable"><code>filenode</code></em></code>

Only validate checksums in the relation with filenode <em class="replaceable"><code>filenode</code></em>.
