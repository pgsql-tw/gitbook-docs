<a id="APP-PGRESETWAL"></a><a id="id-1.9.5.8.1"></a>
...
<a id="id-1.9.5.8.4.1"></a>

`pg_resetwal` [ `-f` | `--force` ] [ `-n` | `--dry-run` ] [<em class="replaceable"><code>option</code></em>...] [ `-D` | `--pgdata` ]<em class="replaceable"><code>datadir</code></em>
...
<code class="option">-c <em class="replaceable"><code>xid</code></em>,<em class="replaceable"><code>xid</code></em></code><br><code class="option">--commit-timestamp-ids=<em class="replaceable"><code>xid</code></em>,<em class="replaceable"><code>xid</code></em></code>
...
<code class="option">-e <em class="replaceable"><code>xid&#95;epoch</code></em></code><br><code class="option">--epoch=<em class="replaceable"><code>xid&#95;epoch</code></em></code>
...
<code class="option">-l <em class="replaceable"><code>walfile</code></em></code><br><code class="option">--next-wal-file=<em class="replaceable"><code>walfile</code></em></code>
...
<code class="option">-m <em class="replaceable"><code>mxid</code></em>,<em class="replaceable"><code>mxid</code></em></code><br><code class="option">--multixact-ids=<em class="replaceable"><code>mxid</code></em>,<em class="replaceable"><code>mxid</code></em></code>
...
<code class="option">-o <em class="replaceable"><code>oid</code></em></code><br><code class="option">--next-oid=<em class="replaceable"><code>oid</code></em></code>
...
<code class="option">-O <em class="replaceable"><code>mxoff</code></em></code><br><code class="option">--multixact-offset=<em class="replaceable"><code>mxoff</code></em></code>
...
<code class="option">--wal-segsize=<em class="replaceable"><code>wal&#95;segment&#95;size</code></em></code>

Set the new WAL segment size, in megabytes. The value must be set to a power of 2 between 1 and 1024 (megabytes). See the same option of [initdb](initdb.md) for more information.
...
<code class="option">-u <em class="replaceable"><code>xid</code></em></code><br><code class="option">--oldest-transaction-id=<em class="replaceable"><code>xid</code></em></code>
...
<code class="option">-x <em class="replaceable"><code>xid</code></em></code><br><code class="option">--next-transaction-id=<em class="replaceable"><code>xid</code></em></code>
...
原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/app-pgresetwal.html)（英文原文，待翻譯）
