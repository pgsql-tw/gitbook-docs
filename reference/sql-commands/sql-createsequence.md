...
[Section 9.17](../../the-sql-language/functions/functions-sequence.md).
...
<a id="id-1.9.3.81.10"></a>

## See Also

[ALTER SEQUENCE](sql-altersequence.md), [DROP SEQUENCE](sql-dropsequence.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-createsequence.html)（英文原文，待翻譯）
