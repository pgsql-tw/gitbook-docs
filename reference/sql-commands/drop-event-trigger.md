<a id="SQL-DROPEVENTTRIGGER"></a><a id="id-1.9.3.110.1"></a>
...
Automatically drop objects that depend on the trigger, and in turn all objects that depend on those objects (see [Section 5.14](../../the-sql-language/ddl/dependency-tracking.md)).
...
[CREATE EVENT TRIGGER](create-event-trigger.md), [ALTER EVENT TRIGGER](alter-event-trigger.md)

---

原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/sql-dropeventtrigger.html)（英文原文，待翻譯）
