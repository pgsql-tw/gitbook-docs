...
[CREATE SERVER](sql-createserver.md), [DROP SERVER](sql-dropserver.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-alterserver.html)（英文原文，待翻譯）
