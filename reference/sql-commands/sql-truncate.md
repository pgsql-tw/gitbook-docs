...
See [Section 13.6](../../the-sql-language/mvcc/mvcc-caveats.md) for more details.
...
see [postgres_fdw](../../appendixes/contrib/postgres-fdw.md).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-truncate.html)（英文原文，待翻譯）
