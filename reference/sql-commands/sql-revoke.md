...
See the description of the [`GRANT`](sql-grant.md) command for
...
The compatibility notes of the [`GRANT`](sql-grant.md) command
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-revoke.html)（英文原文，待翻譯）
