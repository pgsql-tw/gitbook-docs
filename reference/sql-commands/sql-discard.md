...
:   Discards all cached sequence-related state,
    ...
    (See [CREATE SEQUENCE](sql-createsequence.md) for a description of
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-discard.html)（英文原文，待翻譯）
