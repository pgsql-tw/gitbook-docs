<a id="SQL-ALTERCOLLATION"></a><a id="id-1.9.3.5.1"></a>
...
[CREATE COLLATION](create-collation.md), [DROP COLLATION](drop-collation.md)

---

原文：[PostgreSQL 15.19 Documentation](https://www.postgresql.org/docs/15/sql-altercollation.html)（英文原文，待翻譯）
