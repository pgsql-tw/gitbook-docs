...
:   The name of the extension to be
    ...
    found via the server's extension control path (set by [extension_control_path](../../server-administration/runtime-config/runtime-config-client.md#GUC-EXTENSION-CONTROL-PATH).)
...
[Additional Supplied Modules](../../appendixes/contrib/README.md).

The extensions currently available for loading can be identified from the
[`pg_available_extensions`](../../internals/views/view-pg-available-extensions.md)
or
[`pg_available_extension_versions`](../../internals/views/view-pg-available-extension-versions.md)
system views.
...
<a id="id-1.9.3.64.8"></a>

## Examples

Install the [hstore](../../appendixes/contrib/hstore.md) extension into the
...
<a id="id-1.9.3.64.10"></a>

## See Also

[ALTER EXTENSION](sql-alterextension.md), [DROP EXTENSION](sql-dropextension.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-createextension.html)（英文原文，待翻譯）
