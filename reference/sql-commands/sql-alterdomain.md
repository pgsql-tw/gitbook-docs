...
[CREATE DOMAIN](sql-createdomain.md), [DROP DOMAIN](sql-dropdomain.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-alterdomain.html)（英文原文，待翻譯）
