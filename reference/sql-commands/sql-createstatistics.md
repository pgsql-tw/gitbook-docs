...
:   A multivariate statistics kind to be computed in this statistics object.
    ...
    For more information, see [Section 14.2.2](../../the-sql-language/performance-tips/planner-stats.md#PLANNER-STATS-EXTENDED)
    and [Section 69.2](../../internals/planner-stats-details/multivariate-statistics-examples.md).
...
:   The name (optionally schema-qualified) of the table containing the
    column(s) the statistics are computed on; see [ANALYZE](sql-analyze.md) for an explanation of the handling of
    inheritance and partitions.

<a id="id-1.9.3.83.7"></a>
...
<a id="id-1.9.3.83.9"></a>

## Compatibility

There is no `CREATE STATISTICS` command in the SQL standard.

<a id="id-1.9.3.83.10"></a>

## See Also

[ALTER STATISTICS](sql-alterstatistics.md), [DROP STATISTICS](sql-dropstatistics.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-createstatistics.html)（英文原文，待翻譯）
