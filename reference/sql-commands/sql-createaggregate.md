...
are documented in [Section 9.21](../../the-sql-language/functions/functions-aggregate.md). If one defines new
...
(see [CREATE FUNCTION](sql-createfunction.md)).
...
as described in [Section 36.12.1](../../server-programming/extend/xaggr.md#XAGGR-MOVING-AGGREGATES). This requires
...
as described in [Section 36.12.4](../../server-programming/extend/xaggr.md#XAGGR-PARTIAL-AGGREGATES).
...
:   This option specifies whether the final function is a pure function
    ...
    transition state value. See [Notes](sql-createaggregate.md#SQL-CREATEAGGREGATE-NOTES)
...
:   The meanings of `PARALLEL SAFE`, `PARALLEL
    ...
    in [`CREATE FUNCTION`](sql-createfunction.md). An aggregate will not be
...
See [Section 36.12](../../server-programming/extend/xaggr.md).
...
[ALTER AGGREGATE](sql-alteraggregate.md), [DROP AGGREGATE](sql-dropaggregate.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-createaggregate.html)（英文原文，待翻譯）
