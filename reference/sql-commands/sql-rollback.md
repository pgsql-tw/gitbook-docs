...
:   If `AND CHAIN` is specified, a new (not aborted)
    ...
    characteristics (see [SET TRANSACTION](sql-set-transaction.md)) as the
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-rollback.html)（英文原文，待翻譯）
