<a id="SQL-ALTEROPFAMILY"></a><a id="id-1.9.3.22.1"></a>
...
[CREATE OPERATOR FAMILY](create-operator-family.md), [DROP OPERATOR FAMILY](drop-operator-family.md), [CREATE OPERATOR CLASS](create-operator-class.md), [ALTER OPERATOR CLASS](alter-operator-class.md), [DROP OPERATOR CLASS](drop-operator-class.md)
