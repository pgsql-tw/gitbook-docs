...
whole is available at [Section 29.2](../../server-administration/logical-replication/logical-replication-subscription.md) and
[Chapter 29](../../server-administration/logical-replication/README.md).

<a id="id-1.9.3.84.6"></a>

## Parameters

<a id="SQL-CREATESUBSCRIPTION-PARAMS-NAME"></a>

*`subscription_name`* [#](#SQL-CREATESUBSCRIPTION-PARAMS-NAME)
:   The name of the new subscription.
<a id="SQL-CREATESUBSCRIPTION-PARAMS-CONNECTION"></a>

`CONNECTION 'conninfo'` [#](#SQL-CREATESUBSCRIPTION-PARAMS-CONNECTION)
:   The libpq connection string defining how
    to connect to the publisher database. For details see
    [Section 32.1.1](../../client-interfaces/libpq/libpq-connect.md#LIBPQ-CONNSTRING).
<a id="SQL-CREATESUBSCRIPTION-PARAMS-PUBLICATION"></a>

`PUBLICATION publication_name [, ...]` [#](#SQL-CREATESUBSCRIPTION-PARAMS-PUBLICATION)
:   Names of the publications on the publisher to subscribe to.
<a id="SQL-CREATESUBSCRIPTION-PARAMS-WITH"></a>

`WITH ( subscription_parameter [= value] [, ... ] )` [#](#SQL-CREATESUBSCRIPTION-PARAMS-WITH)
:   This clause specifies optional parameters for a subscription.
    ...
    :   Specifies whether the `CREATE SUBSCRIPTION`
        ...
        subscription. See
        [Section 29.2.3](../../server-administration/logical-replication/logical-replication-subscription.md#LOGICAL-REPLICATION-SUBSCRIPTION-EXAMPLES-DEFERRED-SLOT)
        for examples.
    ...
    :   Specifies whether the subscription will request the publisher to send
        ...
        (see [CREATE TYPE](sql-createtype.md) for more about send/receive
        functions).
    ...
    :   Specifies whether to copy pre-existing data in the publications
        ...
        [Notes](sql-createsubscription.md#SQL-CREATESUBSCRIPTION-NOTES) for details.

        See [Notes](sql-createsubscription.md#SQL-CREATESUBSCRIPTION-NOTES) for details of how
    ...
    :   The value of this parameter overrides the
        [synchronous_commit](../../server-administration/runtime-config/runtime-config-wal.md#GUC-SYNCHRONOUS-COMMIT) setting within this
    ...
    :   If true, all replication actions are performed as the subscription
        ...
        [Section 29.11](../../server-administration/logical-replication/logical-replication-security.md).
        The default is `false`.
...
See [Section 29.11](../../server-administration/logical-replication/logical-replication-security.md) for details on
...
[`publish`](sql-createpublication.md#SQL-CREATEPUBLICATION-PARAMS-WITH-PUBLISH)
parameter when copying existing table data, some rows may be copied that
would not be replicated using DML. See
[Section 29.2.2](../../server-administration/logical-replication/logical-replication-subscription.md#LOGICAL-REPLICATION-SUBSCRIPTION-EXAMPLES) for examples.
...
[`pg_subscription`](../../internals/catalogs/catalog-pg-subscription.md)
...
<a id="id-1.9.3.84.10"></a>

## See Also

[ALTER SUBSCRIPTION](sql-altersubscription.md), [DROP SUBSCRIPTION](sql-dropsubscription.md), [CREATE PUBLICATION](sql-createpublication.md), [ALTER PUBLICATION](sql-alterpublication.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-createsubscription.html)（英文原文，待翻譯）
