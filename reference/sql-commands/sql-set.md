...
[Chapter 19](../../server-administration/runtime-config/README.md) can be changed on-the-fly with
`SET`.
...
:   Name of a settable run-time parameter. Available parameters are
    documented in [Chapter 19](../../server-administration/runtime-config/README.md) and below.
...
Besides the configuration parameters documented in [Chapter 19](../../server-administration/runtime-config/README.md), there are a few that can only be
...
functionality; see [Section 9.28.1](../../the-sql-language/functions/functions-admin.md#FUNCTIONS-ADMIN-SET).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-set.html)（英文原文，待翻譯）
