...
函數 current\_setting 可以產生相同的輸出；詳見 [9.26 節](../../the-sql-language/functions-and-operators/system-administration.md)。此外， [pg\_settings ](../../internals/54.-system-views/pg_settings.md)系統檢視表也產出相同的資訊。
