<a id="SQL-CREATEOPFAMILY"></a><a id="id-1.9.3.74.1"></a>
...
[ALTER OPERATOR FAMILY](alter-operator-family.md), [DROP OPERATOR FAMILY](drop-operator-family.md), [CREATE OPERATOR CLASS](create-operator-class.md), [ALTER OPERATOR CLASS](alter-operator-class.md), [DROP OPERATOR CLASS](drop-operator-class.md)
