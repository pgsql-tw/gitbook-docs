...
Use [`ROLLBACK TO`](sql-rollback-to.md) to
rollback to a savepoint. Use [`RELEASE SAVEPOINT`](sql-release-savepoint.md)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-savepoint.html)（英文原文，待翻譯）
