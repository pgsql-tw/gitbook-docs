...
[intarray](../../appendixes/contrib/intarray.md) module for the complete example.
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-createopclass.html)（英文原文，待翻譯）
