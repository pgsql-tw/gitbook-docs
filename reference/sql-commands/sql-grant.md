...
:   Specific types of privileges, as defined in [Section 5.8](../../the-sql-language/ddl/ddl-priv.md).
...
and `ADMIN`; see [Section 21.3](../../server-administration/user-manag/role-membership.md)
...
of the new membership; see [Section 21.3](../../server-administration/user-manag/role-membership.md) for
...
The [`REVOKE`](sql-revoke.md) command is used
...
See [Section 5.8](../../the-sql-language/ddl/ddl-priv.md) for more information about specific
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-grant.html)（英文原文，待翻譯）
