...
<a id="id-1.9.3.80.10"></a>

## See Also

[ALTER SCHEMA](sql-alterschema.md), [DROP SCHEMA](sql-dropschema.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-createschema.html)（英文原文，待翻譯）
