...
Their meaning is detailed in [Section 36.15](../../server-programming/extend/xoper-optimization.md).
...
Refer to [Section 36.14](../../server-programming/extend/xoper.md) and [Section 36.15](../../server-programming/extend/xoper-optimization.md)
...
is hard-wired. See [Section 4.1.6](../../the-sql-language/sql-syntax/sql-syntax-lexical.md#SQL-PRECEDENCE) for precedence details.
...
Use [`DROP OPERATOR`](sql-dropoperator.md) to delete user-defined operators
from a database. Use [`ALTER OPERATOR`](sql-alteroperator.md) to modify operators in a
database.
...
[ALTER OPERATOR](sql-alteroperator.md), [CREATE OPERATOR CLASS](sql-createopclass.md), [DROP OPERATOR](sql-dropoperator.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-createoperator.html)（英文原文，待翻譯）
