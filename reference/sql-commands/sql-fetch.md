<a id="id-1.9.3.149.1"></a><a id="id-1.9.3.149.2"></a>
...
see [Section 41.7.3](../../server-programming/plpgsql/plpgsql-cursors.md#PLPGSQL-CURSOR-USING).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-fetch.html)（英文原文，待翻譯）
