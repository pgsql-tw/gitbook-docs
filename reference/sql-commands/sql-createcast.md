...
[CREATE TYPE](sql-createtype.md) for
more information.
...
[DROP CAST](sql-dropcast.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-createcast.html)（英文原文，待翻譯）
