...
Refer to [Section 36.4](../../server-programming/extend/xproc.md) for further information on writing
procedures.

<a id="id-1.9.3.76.6"></a>
...
:   `SECURITY INVOKER` indicates that the procedure
...
:   A string constant defining the procedure; the meaning depends on the
    ...
    It is often helpful to use dollar quoting (see [Section 4.1.2.4](../../the-sql-language/sql-syntax/sql-syntax-lexical.md#SQL-SYNTAX-DOLLAR-QUOTING)) to write the procedure definition
...
See [CREATE FUNCTION](sql-createfunction.md) for more details on function
...
<a id="id-1.9.3.76.10"></a>

## See Also

[ALTER PROCEDURE](sql-alterprocedure.md), [DROP PROCEDURE](sql-dropprocedure.md), [CALL](sql-call.md), [CREATE FUNCTION](sql-createfunction.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/sql-createprocedure.html)（英文原文，待翻譯）
