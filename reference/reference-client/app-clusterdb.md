...
command [CLUSTER](../sql-commands/sql-cluster.md).
...
In case of difficulty, see [CLUSTER](../sql-commands/sql-cluster.md)
...
[CLUSTER](../sql-commands/sql-cluster.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/app-clusterdb.html)（英文原文，待翻譯）
