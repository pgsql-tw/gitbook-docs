...
<a id="id-1.9.4.13.4.1"></a>

`pg_config` [*`option`*...]

<a id="id-1.9.4.13.5"></a>
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/app-pgconfig.html)（英文原文，待翻譯）
