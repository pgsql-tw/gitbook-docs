...
SQL command [`CREATE DATABASE`](../sql-commands/sql-createdatabase.md).
...
`-D tablespace`<br>`--tablespace=tablespace`
...
:   Specifies the character encoding scheme to be used in this
    ...
    [Section 23.3.1](../../server-administration/charset/multibyte.md#MULTIBYTE-CHARSET-SUPPORTED).

`-l locale`<br>`--locale=locale`
...
`-O owner`<br>`--owner=owner`
:   Specifies the database user who will own the new database.
    (This name is processed as a double-quoted identifier.)

`-S strategy`<br>`--strategy=strategy`
:   Specifies the database creation strategy. See
    [CREATE DATABASE STRATEGY](../sql-commands/sql-createdatabase.md#CREATE-DATABASE-STRATEGY) for more details.

`-T template`<br>`--template=template`
...
SQL command [`CREATE DATABASE`](../sql-commands/sql-createdatabase.md); see there for more information
about them.
...
In case of difficulty, see [CREATE DATABASE](../sql-commands/sql-createdatabase.md)
...
<a id="id-1.9.4.4.10"></a>

## See Also

[dropdb](app-dropdb.md), [CREATE DATABASE](../sql-commands/sql-createdatabase.md)

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/app-createdb.html)（英文原文，待翻譯）
