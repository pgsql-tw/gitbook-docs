...
See [Chapter 34](../../client-interfaces/ecpg/README.md) for more information on that topic.
...
the installation can be found out using [pg_config](app-pgconfig.md).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/app-ecpg.html)（英文原文，待翻譯）
