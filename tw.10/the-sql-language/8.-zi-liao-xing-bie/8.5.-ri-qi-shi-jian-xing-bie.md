...
PostgreSQL supports the full set of SQL date and time types, shown in Table 8.9. The operations available on these data types are described in [Section 9.9](../9.-han-shi-ji-yun-suan-zi/9.9-ri-qi-shi-jian-han-shi-ji-yun-suan-zi.md). Dates are counted according to the Gregorian calendar, even in years before that calendar was introduced \(see [Section B.4](../../viii.-fu-lu/b.-ri-qi-shi-jian-ge-shi-zhi-yuan/b.4.-ri-qi-shi-jian-de-yan-ge.md) for more information\).
