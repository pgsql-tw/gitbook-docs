...
[D.3.1. Queries Are Restricted to XPath 1.0](xml-limits-conformance.md#FUNCTIONS-XML-LIMITS-XPATH1)

[D.3.2. Incidental Limits of the Implementation](xml-limits-conformance.md#FUNCTIONS-XML-LIMITS-POSTGRESQL)

<a id="id-1.11.5.13.2"></a>
...
[function library changes](https://www.w3.org/TR/2010/REC-xpath-functions-20101214/#xpath1-compatibility)
and
[language changes](https://www.w3.org/TR/xpath20/#id-backwards-compatibility)
...
as those in [Section 9.8](../../the-sql-language/functions/functions-formatting.md)) explicitly to
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/xml-limits-conformance.html)（英文原文，待翻譯）
