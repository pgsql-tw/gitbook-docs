...
[CREATE SERVER](../../reference/sql-commands/sql-createserver.md) and
...
:   libpq-style connection info string, for example
    ...
    For details see [Section 32.1.1](../../client-interfaces/libpq/libpq-connect.md#LIBPQ-CONNSTRING).
...
See the documentation of the equivalent [`use_scram_passthrough`](postgres-fdw.md#POSTGRES-FDW-OPTION-USE-SCRAM-PASSTHROUGH)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/contrib-dblink-connect.html)（英文原文，待翻譯）
