...
[Table F.29](seg.md#SEG-REPR-TABLE) gives an overview of allowed
representations; [Table F.30](seg.md#SEG-INPUT-EXAMPLES) shows some
examples.

In [Table F.29](seg.md#SEG-REPR-TABLE), *`x`*, *`y`*, and
*`delta`* denote
...
<table border="1" class="table" summary="seg External Representations"><colgroup><col/><col/></colgroup><tbody><tr><td><code class="literal"><em class="replaceable"><code>x</code></em></code></td><td>Single value (zero-length interval)
...
<br><a id="SEG-INPUT-EXAMPLES"></a>

**Table F.30. Examples of Valid `seg` Input**

<table border="1" class="table" summary="Examples of Valid seg Input"><colgroup><col class="col1"/><col class="col2"/></colgroup><tbody><tr><td><code class="literal">5.0</code></td><td>
...
`seg` values.
The operators supported by the GiST operator class are shown in [Table F.31](seg.md#SEG-GIST-OPERATORS).

<a id="SEG-GIST-OPERATORS"></a>

**Table F.31. Seg GiST Operators**

<table border="1" class="table" summary="Seg GiST Operators"><colgroup><col/></colgroup><thead><tr><th class="func_table_entry"><p class="func_signature">
        Operator
       </p>
<p>
        Description
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/seg.html)（英文原文，待翻譯）
