...
[Section 4.1.2.1](../../the-sql-language/sql-syntax/sql-syntax-lexical.md#SQL-SYNTAX-STRINGS) for more on the handling of string
constants.
...
shown in [Table F.6](hstore.md#HSTORE-OP-TABLE), the functions
in [Table F.7](hstore.md#HSTORE-FUNC-TABLE).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/hstore.html)（英文原文，待翻譯）
