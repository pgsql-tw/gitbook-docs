...
[shared_preload_libraries](../../server-administration/runtime-config/runtime-config-client.md#GUC-SHARED-PRELOAD-LIBRARIES). In the latter case, the
...
`pg_prewarm.autoprewarm` (`boolean`) <a id="id-1.11.7.40.5.2.1.1.3"></a>
...
`pg_prewarm.autoprewarm_interval` (`integer`) <a id="id-1.11.7.40.5.3.1.1.3"></a>
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/pgprewarm.html)（英文原文，待翻譯）
