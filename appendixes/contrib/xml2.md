...
[Table F.37](xml2.md#XML2-FUNCTIONS-TABLE) shows the functions provided by this module.
...
<table border="1" class="table" summary="xml2 Functions"><colgroup><col/></colgroup><thead><tr><th class="func_table_entry"><p class="func_signature">
        Function
       </p>
<p>
        Description
...
[Table F.38](xml2.md#XML2-XPATH-TABLE-PARAMETERS).

<a id="XML2-XPATH-TABLE-PARAMETERS"></a>

**Table F.38. `xpath_table` Parameters**

<table border="1" class="table" summary="xpath_table Parameters"><colgroup><col class="col1"/><col class="col2"/></colgroup><thead><tr><th>Parameter</th><th>Description</th></tr></thead><tbody><tr><td><em class="parameter"><code>key</code></em></td><td>
<p>
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/xml2.html)（英文原文，待翻譯）
