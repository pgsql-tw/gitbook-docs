## F.9. citext — a case-insensitive character string type [#](#CITEXT)
...
[Section 23.2.2.4](../../server-administration/charset/collation.md#COLLATION-NONDETERMINISTIC)) instead of this module. They
...
### F.9.1. Rationale [#](#CITEXT-RATIONALE)
...
### F.9.2. How to Use It [#](#CITEXT-HOW-TO-USE-IT)
...
### F.9.3. String Comparison Behavior [#](#CITEXT-STRING-COMPARISON-BEHAVIOR)
...
### F.9.4. Limitations [#](#CITEXT-LIMITATIONS)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/citext.html)（英文原文，待翻譯）
