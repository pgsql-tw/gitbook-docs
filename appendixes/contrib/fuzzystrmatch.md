## F.16. fuzzystrmatch — determine string similarities and distance [#](#FUZZYSTRMATCH)
...
be used for efficiency, see [Section 65.4](../../internals/indextypes/gin.md) and this example:
...
Search features can be used. See [Chapter 12](../../the-sql-language/textsearch/README.md) and this
example:
...
[Section 5.4](../../the-sql-language/ddl/ddl-generated-columns.md).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/fuzzystrmatch.html)（英文原文，待翻譯）
