...
[J.3.4. Syntax Check](docguide-build.md#DOCGUIDE-BUILD-SYNTAX-CHECK)
...
To produce HTML documentation with the stylesheet used on [postgresql.org](https://www.postgresql.org/docs/current/) instead of the
...
files include references to stylesheets hosted on [postgresql.org](https://www.postgresql.org/docs/current/) and
...
### J.3.4. Syntax Check [#](#DOCGUIDE-BUILD-SYNTAX-CHECK)
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/docguide-build.html)（英文原文，待翻譯）
