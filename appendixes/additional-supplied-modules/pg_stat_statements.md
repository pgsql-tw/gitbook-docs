...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p><code>userid</code> <code>oid</code> (references <a href="../../internals/system-catalogs/pg_authid.md"><code>pg_authid</code></a>.<code>oid</code>)</p><p>OID of user who executed the statement</p>                                                                     |
| <p><code>dbid</code> <code>oid</code> (references <a href="../../internals/system-catalogs/pg_database.md"><code>pg_database</code></a>.<code>oid</code>)</p><p>OID of database in which the statement was executed</p>                                                      |
...
| <p><code>blk_read_time</code> <code>double precision</code></p><p>Total time the statement spent reading blocks, in milliseconds (if <a href="../../server-administration/server-configuration/run-time-statistics.md#GUC-TRACK-IO-TIMING">track_io_timing</a> is enabled, otherwise zero)</p>  |
| <p><code>blk_write_time</code> <code>double precision</code></p><p>Total time the statement spent writing blocks, in milliseconds (if <a href="../../server-administration/server-configuration/run-time-statistics.md#GUC-TRACK-IO-TIMING">track_io_timing</a> is enabled, otherwise zero)</p> |
