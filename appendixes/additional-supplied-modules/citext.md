...
[F.10.1. Rationale](#id-1.11.7.19.6)

[F.10.2. How to Use It](#id-1.11.7.19.7)

[F.10.3. String Comparison Behavior](#id-1.11.7.19.8)

[F.10.4. Limitations](#id-1.11.7.19.9)

[F.10.5. Author](#id-1.11.7.19.10)
...
* The approach of lower-casing strings for comparison does not handle some Unicode special cases correctly, for example when one upper-case letter has two lower-case letter equivalents. Unicode distinguishes between <em class="firstterm">case mapping</em> and <em class="firstterm">case folding</em> for this reason. Use nondeterministic collations instead of `citext` to handle that correctly.

<a id="id-1.11.7.19.10"></a>
