...
[F.14.1. Configuration](#id-1.11.7.23.4)

[F.14.2. Usage](#id-1.11.7.23.5)
...
Real-world usage will involve including it in a text search configuration as described in [Chapter 12](../../the-sql-language/12.-quan-wen-jian-suo/README.md). That might look like this:
