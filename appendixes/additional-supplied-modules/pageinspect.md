...
[F.25.1. General Functions](#id-1.11.7.34.4)

[F.25.2. Heap Functions](#id-1.11.7.34.5)

[F.25.3. B-Tree Functions](#id-1.11.7.34.6)

[F.25.4. BRIN Functions](#id-1.11.7.34.7)

[F.25.5. GIN Functions](#id-1.11.7.34.8)

[F.25.6. GiST Functions](#id-1.11.7.34.9)

[F.25.7. Hash Functions](#id-1.11.7.34.10)
...
<a id="id-1.11.7.34.4"></a>

## F.25.1. General Functions

`get_raw_page(relname text, fork text, blkno bigint) returns bytea` <a id="id-1.11.7.34.4.2.1.1.2"></a>

`get_raw_page` reads the specified block of the named relation and returns a copy as a `bytea` value. This allows a single time-consistent copy of the block to be obtained. <em class="replaceable"><code>fork</code></em> should be `'main'` for the main data fork, `'fsm'` for the [free space map](../../internals/database-physical-storage/free-space-map.md), `'vm'` for the [visibility map](../../internals/database-physical-storage/visibility-map.md), or `'init'` for the initialization fork.
...
`page_header(page bytea) returns record` <a id="id-1.11.7.34.4.2.3.1.2"></a>
...
`page_checksum(page bytea, blkno bigint) returns smallint` <a id="id-1.11.7.34.4.2.4.1.2"></a>
...
`fsm_page_contents(page bytea) returns text` <a id="id-1.11.7.34.4.2.5.1.2"></a>
...
<a id="id-1.11.7.34.5"></a>

## F.25.2. Heap Functions

`heap_page_items(page bytea) returns setof record` <a id="id-1.11.7.34.5.2.1.1.2"></a>
...
`tuple_data_split(rel_oid oid, t_data bytea, t_infomask integer, t_infomask2 integer, t_bits text [, do_detoast bool]) returns bytea[]` <a id="id-1.11.7.34.5.2.2.1.2"></a>
...
If <em class="parameter"><code>do&#95;detoast</code></em> is `true`, attributes will be detoasted as needed. Default value is `false`.

`heap_page_item_attrs(page bytea, rel_oid regclass [, do_detoast bool]) returns setof record` <a id="id-1.11.7.34.5.2.3.1.2"></a>

`heap_page_item_attrs` is equivalent to `heap_page_items` except that it returns tuple raw data as an array of attributes that can optionally be detoasted by <em class="parameter"><code>do&#95;detoast</code></em> which is `false` by default.
...
`heap_tuple_infomask_flags(t_infomask integer, t_infomask2 integer) returns record` <a id="id-1.11.7.34.5.2.4.1.2"></a>
...
<a id="id-1.11.7.34.6"></a>

## F.25.3. B-Tree Functions

`bt_metap(relname text) returns record` <a id="id-1.11.7.34.6.2.1.1.2"></a>
...
`bt_page_stats(relname text, blkno bigint) returns record` <a id="id-1.11.7.34.6.2.2.1.2"></a>
...
`bt_page_items(relname text, blkno bigint) returns setof record` <a id="id-1.11.7.34.6.2.3.1.2"></a>
...
<a id="id-1.11.7.34.7"></a>

## F.25.4. BRIN Functions

`brin_page_type(page bytea) returns text` <a id="id-1.11.7.34.7.2.1.1.2"></a>
...
`brin_metapage_info(page bytea) returns record` <a id="id-1.11.7.34.7.2.2.1.2"></a>
...
`brin_revmap_data(page bytea) returns setof tid` <a id="id-1.11.7.34.7.2.3.1.2"></a>
...
`brin_page_items(page bytea, index oid) returns setof record` <a id="id-1.11.7.34.7.2.4.1.2"></a>
...
<a id="id-1.11.7.34.8"></a>

## F.25.5. GIN Functions

`gin_metapage_info(page bytea) returns record` <a id="id-1.11.7.34.8.2.1.1.2"></a>
...
`gin_page_opaque_info(page bytea) returns record` <a id="id-1.11.7.34.8.2.2.1.2"></a>
...
`gin_leafpage_items(page bytea) returns setof record` <a id="id-1.11.7.34.8.2.3.1.2"></a>
...
<a id="id-1.11.7.34.9"></a>

## F.25.6. GiST Functions

`gist_page_opaque_info(page bytea) returns record` <a id="id-1.11.7.34.9.2.1.1.2"></a>
...
`gist_page_items(page bytea, index_oid regclass) returns setof record` <a id="id-1.11.7.34.9.2.2.1.2"></a>
...
`gist_page_items_bytea(page bytea) returns setof record` <a id="id-1.11.7.34.9.2.3.1.2"></a>
...
<a id="id-1.11.7.34.10"></a>

## F.25.7. Hash Functions

`hash_page_type(page bytea) returns text` <a id="id-1.11.7.34.10.2.1.1.2"></a>
...
`hash_page_stats(page bytea) returns setof record` <a id="id-1.11.7.34.10.2.2.1.2"></a>
...
`hash_page_items(page bytea) returns setof record` <a id="id-1.11.7.34.10.2.3.1.2"></a>
...
`hash_bitmap_info(index oid, blkno bigint) returns record` <a id="id-1.11.7.34.10.2.4.1.2"></a>
...
`hash_metapage_info(page bytea) returns record` <a id="id-1.11.7.34.10.2.5.1.2"></a>
