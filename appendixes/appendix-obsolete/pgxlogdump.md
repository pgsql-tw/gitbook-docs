...
[pg_waldump](../../reference/reference-server/pgwaldump.md) for documentation of `pg_waldump` and see
[the release notes for PostgreSQL 10](../release/release-prior.md) for details
on this change.

---

原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/pgxlogdump.html)（英文原文，待翻譯）
