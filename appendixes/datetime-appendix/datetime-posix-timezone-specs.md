...
in [Section B.4](datetime-config-files.md).
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/datetime-posix-timezone-specs.html)（英文原文，待翻譯）
