...
[TimeZone](../../server-administration/runtime-config/runtime-config-client.md#GUC-TIMEZONE) parameter is set
...
原文：[PostgreSQL 18.6 Documentation](https://www.postgresql.org/docs/18/datetime-invalid-input.html)（英文原文，待翻譯）
